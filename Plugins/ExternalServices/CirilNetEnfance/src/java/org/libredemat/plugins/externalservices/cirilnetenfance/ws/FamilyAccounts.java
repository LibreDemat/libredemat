...
public class FamilyAccounts {
    ...
    public FamilyAccounts(String endPoint, String zipCode, Long homeFolderId, String externalLibreDematId, String externalId){
        super();
    ...
    public Document getFamilyResponse() throws SOAPException, MalformedURLException {
        ...
        try {
            ...
            Name thirdthElement = enveloppe.createName("ExternalLibreDematId");
            ...
            f3.addTextNode(externalLibreDematId);
    ...
    public final String getExternalLibreDematId() {
        return externalLibreDematId;
    }

    public final void setExternalLibreDematId(String externalLibreDematId) {
        this.externalLibreDematId = externalLibreDematId;
    }
