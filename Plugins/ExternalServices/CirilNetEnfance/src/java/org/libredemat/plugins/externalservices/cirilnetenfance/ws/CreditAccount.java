...
public class CreditAccount {
    ...
    public void paid() {
        try {
            ...
            Name attExternalLibreDematId = enveloppe.createName("externalLibreDematId");
            ...
            familyPart.addAttribute(attExternalLibreDematId, externalHomeFolderId);
            ...
            for(PurchaseItem item : purchaseItems){
                if(item instanceof ExternalDepositAccountItem){
                    ...
                    depot.addAttribute(attExternalLibreDematId, "0");
