...
import org.libredemat.xml.request.school.SchoolRegistrationRequestDocument;
...
import org.libredemat.plugins.externalservices.cirilnetenfance.ws.Registration;
    ...
    public String sendRequest(final XmlObject xmlRequest) throws CvqException {
        ...
        if (request instanceof SchoolRegistrationRequest) {
            ...
            if (repDoc.containsKey("school")) {
                ...
                org.libredemat.business.request.school.SchoolRegistrationRequest srr =
                    org.libredemat.business.request.school.SchoolRegistrationRequest.xmlToModel(srrDocument);
