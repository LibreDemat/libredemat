...
import org.libredemat.external.endpoint.DocumentListServiceEndpoint;
import org.libredemat.external.endpoint.DocumentServiceEndpoint;
...
public class DocumentServiceEndpointTest extends ExternalServiceTestCase {
    ...
    public void testGetDocumentList() throws Exception {
        ...
        try {
            ...
            org.libredemat.DocumentType document = getDocListResponse.getDocumentArray(0);
