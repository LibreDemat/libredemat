...
import org.libredemat.testtool.HasInnerProperty;
import org.libredemat.util.Critere;
import org.libredemat.xml.request.technical.TechnicalInterventionRequestDocument;
        ...
        context.checking(new Expectations() {{
            ...
            oneOf(mockExternalService)
                .sendRequest(with(AllOf.<TechnicalInterventionRequestDocument>allOf(
                        ...
                        HasInnerProperty.<TechnicalInterventionRequestDocument>hasProperty("homeFolder.externalLibreDematId"))));
