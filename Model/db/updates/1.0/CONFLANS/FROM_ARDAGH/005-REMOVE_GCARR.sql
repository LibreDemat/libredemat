...
delete from request_action ra
    where ra.request_id in
        (select r.id from request r, request_type rt
            ...
            and   rt.label = 'Gifsuryvette Club Ado Registration');
...
drop table gifsuryvette_club_ado_registration_request cascade;
...
delete from request_type
    where label = 'Gifsuryvette Club Ado Registration';
