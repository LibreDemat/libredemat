...
delete from request_action ra
    where ra.request_id in
        (select r.id from request r, request_type rt
            ...
            and   rt.label = 'Gifsuryvette Inscription Scolaire');
...
drop table gifsuryvette_inscription_scolaire_request cascade;
...
delete from request_type
    where label = 'Gifsuryvette Inscription Scolaire';
