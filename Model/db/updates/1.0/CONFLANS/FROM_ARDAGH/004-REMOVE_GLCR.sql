...
delete from request_action ra
    where ra.request_id in
        (select r.id from request r, request_type rt
            ...
            and   rt.label = 'Gifsuryvette Leisure Center Registration');
...
drop table gifsuryvette_leisure_center_registration_request cascade;
...
delete from request_type
    where label = 'Gifsuryvette Leisure Center Registration';
