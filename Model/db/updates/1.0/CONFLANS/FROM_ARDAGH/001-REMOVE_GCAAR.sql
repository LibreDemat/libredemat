...
delete from request_action ra
    where ra.request_id in
        (select r.id from request r, request_type rt
            ...
            and   rt.label = 'Gifsuryvette Canteen And Activities');
...
drop table gifsuryvette_canteen_and_activities_request cascade;
...
delete from request_type
    where label = 'Gifsuryvette Canteen And Activities';

drop table gifsuryvette_canteen_and_activities_request_jours_frequentation;
