...
delete from request_action ra
    where ra.request_id in
        (select r.id from request r, request_type rt
            ...
            and   rt.label = 'Gifsuryvette Medical Form');
...
drop table gifsuryvette_medical_form_request cascade;
...
delete from request_type
    where label = 'Gifsuryvette Medical Form';

drop table gmfr_personne_autorisee;
