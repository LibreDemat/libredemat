...
delete from request_action ra
    where ra.request_id in
        (select r.id from request r, request_type rt
            ...
            and   rt.label = 'Global School Services Registration');
...
drop table global_school_services_registration_request cascade;
...
delete from request_type
    where label = 'Global School Services Registration';
