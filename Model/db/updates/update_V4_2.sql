...
update purchase_item set key = request_id, key_owner = 'libredemat' where request_id is not null;
...
update request set specific_data_class = 'org.libredemat.business.request.urbanism.AlignmentCertificateRequestData' where request_type_id = (select id from request_type where label = 'Alignment Certificate');
update request set specific_data_class = 'org.libredemat.business.request.urbanism.AlignmentNumberingConnectionRequestData' where request_type_id = (select id from request_type where label = 'Alignment Numbering Connection');
update request set specific_data_class = 'org.libredemat.business.request.civil.BirthDetailsRequestData' where request_type_id = (select id from request_type where label = 'Birth Details');
update request set specific_data_class = 'org.libredemat.business.request.environment.BulkyWasteCollectionRequestData' where request_type_id = (select id from request_type where label = 'Bulky Waste Collection');
update request set specific_data_class = 'org.libredemat.business.request.environment.CompostableWasteCollectionRequestData' where request_type_id = (select id from request_type where label = 'Compostable Waste Collection');
update request set specific_data_class = 'org.libredemat.business.request.civil.DeathDetailsRequestData' where request_type_id = (select id from request_type where label = 'Death Details');
update request set specific_data_class = 'org.libredemat.business.request.social.DomesticHelpRequestData' where request_type_id = (select id from request_type where label = 'Domestic Help');
update request set specific_data_class = 'org.libredemat.business.request.election.ElectoralRollRegistrationRequestData' where request_type_id = (select id from request_type where label = 'Electoral Roll Registration');
update request set specific_data_class = 'org.libredemat.business.request.social.HandicapCompensationAdultRequestData' where request_type_id = (select id from request_type where label = 'Handicap Compensation Adult');
update request set specific_data_class = 'org.libredemat.business.request.social.HandicapCompensationChildRequestData' where request_type_id = (select id from request_type where label = 'Handicap Compensation Child');
update request set specific_data_class = 'org.libredemat.business.request.localpolice.HolidaySecurityRequestData' where request_type_id = (select id from request_type where label = 'Holiday Security');
update request set specific_data_class = 'org.libredemat.business.request.ecitizen.HomeFolderModificationRequestData' where request_type_id = (select id from request_type where label = 'Home Folder Modification');
update request set specific_data_class = 'org.libredemat.business.request.leisure.culture.LibraryRegistrationRequestData' where request_type_id = (select id from request_type where label = 'Library Registration');
update request set specific_data_class = 'org.libredemat.business.request.civil.MarriageDetailsRequestData' where request_type_id = (select id from request_type where label = 'Marriage Details');
update request set specific_data_class = 'org.libredemat.business.request.military.MilitaryCensusRequestData' where request_type_id = (select id from request_type where label = 'Military Census');
update request set specific_data_class = 'org.libredemat.business.request.leisure.music.MusicSchoolRegistrationRequestData' where request_type_id = (select id from request_type where label = 'Music School Registration');
update request set specific_data_class = 'org.libredemat.business.request.school.PerischoolActivityRegistrationRequestData' where request_type_id = (select id from request_type where label = 'Perischool Activity Registration');
update request set specific_data_class = 'org.libredemat.business.request.reservation.PlaceReservationRequestData' where request_type_id = (select id from request_type where label = 'Place Reservation');
update request set specific_data_class = 'org.libredemat.business.request.school.RecreationActivityRegistrationRequestData' where request_type_id = (select id from request_type where label = 'Recreation Activity Registration');
update request set specific_data_class = 'org.libredemat.business.request.social.RemoteSupportRequestData' where request_type_id = (select id from request_type where label = 'Remote Support');
update request set specific_data_class = 'org.libredemat.business.request.school.SchoolCanteenRegistrationRequestData' where request_type_id = (select id from request_type where label = 'School Canteen Registration');
update request set specific_data_class = 'org.libredemat.business.request.school.SchoolRegistrationRequestData' where request_type_id = (select id from request_type where label = 'School Registration');
update request set specific_data_class = 'org.libredemat.business.request.urbanism.SewerConnectionRequestData' where request_type_id = (select id from request_type where label = 'Sewer Connection');
update request set specific_data_class = 'org.libredemat.business.request.leisure.SmsNotificationRequestData' where request_type_id = (select id from request_type where label = 'Sms Notification');
update request set specific_data_class = 'org.libredemat.business.request.school.StudyGrantRequestData' where request_type_id = (select id from request_type where label = 'Study Grant');
update request set specific_data_class = 'org.libredemat.business.request.technical.TechnicalInterventionRequestData' where request_type_id = (select id from request_type where label = 'Technical Intervention');
update request set specific_data_class = 'org.libredemat.business.request.ecitizen.VoCardRequestData' where request_type_id = (select id from request_type where label = 'VO Card');
