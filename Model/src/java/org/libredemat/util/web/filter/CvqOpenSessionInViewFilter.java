package org.libredemat.util.web.filter;
...
public class CvqOpenSessionInViewFilter extends GenericFilterBean {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if(entityManagerFactory == null){
                entityManagerFactory = Persistence.createEntityManagerFactory("libredematPersistenceUnit", lacb.getJpaConfigurations());
     ...
     * {@link org.libredemat.util.web.struts.CvqExceptionHandler}
