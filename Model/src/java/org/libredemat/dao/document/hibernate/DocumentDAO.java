 ...
 * 
 * TODO; refactor to conform to simple search DAO method pattern in LibreDemat
 */
public class DocumentDAO extends JpaTemplate<Document, Long> implements IDocumentDAO, PostDeleteEventListener {
    ...
    public List<Document> listProvidedDocuments(
        ...
        String query = "from Document d where d.state not in (" +
            "org.libredemat.business.document.DocumentState.DRAFT, " +
            "org.libredemat.business.document.DocumentState.REFUSED, " +
            "org.libredemat.business.document.DocumentState.OUTDATED" +
            ")" +
