package org.libredemat.business.users.external;
...
public class IndividualMapping implements Serializable {
    ...
    @Column(name="external_libredemat_id")
    ...
    public IndividualMapping(Long individualId, String externalId, HomeFolderMapping homeFolderMapping) {
        this.externalLibreDematId = UUID.randomUUID().toString();
    ...
    public void setExternalLibreDematId(String externalLibreDematId) {
        this.externalLibreDematId =
            externalLibreDematId != null ? externalLibreDematId : "";
    }
