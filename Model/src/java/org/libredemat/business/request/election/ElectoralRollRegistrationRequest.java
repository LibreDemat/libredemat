...
public class ElectoralRollRegistrationRequest extends Request implements Serializable {
    ...
    public final ElectoralRollRegistrationRequestDocument modelToXml() {
        ...
        if (getMotive() != null)
            electoralRollRegistrationRequest.setMotive(org.libredemat.xml.request.election.ElectoralMotiveType.Enum.forString(getMotive().getLegacyLabel()));
        ...
        if (getSubjectNationality() != null)
            electoralRollRegistrationRequest.setSubjectNationality(org.libredemat.xml.common.NationalityType.Enum.forString(getSubjectNationality().getLegacyLabel()));
    ...
    public static ElectoralRollRegistrationRequest xmlToModel(ElectoralRollRegistrationRequestDocument electoralRollRegistrationRequestDoc) {
        ...
        if (electoralRollRegistrationRequestXml.getMotive() != null)
            electoralRollRegistrationRequest.setMotive(org.libredemat.business.request.election.ElectoralMotiveType.forString(electoralRollRegistrationRequestXml.getMotive().toString()));
        else
            electoralRollRegistrationRequest.setMotive(org.libredemat.business.request.election.ElectoralMotiveType.getDefaultElectoralMotiveType());
        ...
        if (electoralRollRegistrationRequestXml.getSubjectNationality() != null)
            electoralRollRegistrationRequest.setSubjectNationality(org.libredemat.business.users.NationalityType.forString(electoralRollRegistrationRequestXml.getSubjectNationality().toString()));
        else
            electoralRollRegistrationRequest.setSubjectNationality(org.libredemat.business.users.NationalityType.getDefaultNationalityType());
    ...
    public final void setMotive(final org.libredemat.business.request.election.ElectoralMotiveType motive) {
        electoralRollRegistrationRequestData.setMotive(motive);
    }

    
    public final org.libredemat.business.request.election.ElectoralMotiveType getMotive() {
    ...
    public final void setSubjectAddressOutsideCity(final org.libredemat.business.users.Address subjectAddressOutsideCity) {
        electoralRollRegistrationRequestData.setSubjectAddressOutsideCity(subjectAddressOutsideCity);
    }

    
    public final org.libredemat.business.users.Address getSubjectAddressOutsideCity() {
        return electoralRollRegistrationRequestData.getSubjectAddressOutsideCity();
    }
  
    public final void setSubjectNationality(final org.libredemat.business.users.NationalityType subjectNationality) {
        electoralRollRegistrationRequestData.setSubjectNationality(subjectNationality);
    }

    
    public final org.libredemat.business.users.NationalityType getSubjectNationality() {
