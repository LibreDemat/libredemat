...
public class HandicapCompensationAdultRequest extends Request implements Serializable {
    ...
    public final HandicapCompensationAdultRequestDocument modelToXml() {
        ...
        if (getAdditionalFee() != null) {
            org.libredemat.xml.request.social.HcarAdditionalFeeType[] additionalFeeTypeTab = new org.libredemat.xml.request.social.HcarAdditionalFeeType[getAdditionalFee().size()];
        ...
        if (getCareServices() != null) {
            org.libredemat.xml.request.social.HcarCareServiceType[] careServicesTypeTab = new org.libredemat.xml.request.social.HcarCareServiceType[getCareServices().size()];
        ...
        if (getDwellingKind() != null)
            hcarDwellingTypeDwelling.setDwellingKind(org.libredemat.xml.request.social.HcarDwellingKindType.Enum.forString(getDwellingKind().getLegacyLabel()));
        ...
        if (getDwellingReceptionType() != null)
            hcarDwellingTypeDwelling.setDwellingReceptionType(org.libredemat.xml.request.social.HcarDwellingReceptionKindType.Enum.forString(getDwellingReceptionType().getLegacyLabel()));
        ...
        if (getFamilyAssistanceMembers() != null) {
            org.libredemat.xml.request.social.HcarFamilyAssistanceMemberType[] familyAssistanceMembersTypeTab = new org.libredemat.xml.request.social.HcarFamilyAssistanceMemberType[getFamilyAssistanceMembers().size()];
        ...
        if (getFamilyDependents() != null) {
            org.libredemat.xml.request.social.HcarFamilyDependentType[] familyDependentsTypeTab = new org.libredemat.xml.request.social.HcarFamilyDependentType[getFamilyDependents().size()];
        ...
        if (getFamilyStatus() != null)
            hcarFamilyTypeFamily.setFamilyStatus(org.libredemat.xml.common.FamilyStatusType.Enum.forString(getFamilyStatus().getLegacyLabel()));
        ...
        if (getHomeIntervenants() != null) {
            org.libredemat.xml.request.social.HcarHomeIntervenantType[] homeIntervenantsTypeTab = new org.libredemat.xml.request.social.HcarHomeIntervenantType[getHomeIntervenants().size()];
        ...
        if (getLegalAccessKind() != null)
            hcarLegalAccessTypeLegalAccess.setLegalAccessKind(org.libredemat.xml.request.social.HcarLegalAccessKindType.Enum.forString(getLegalAccessKind().getLegacyLabel()));
        ...
        if (getLegalAccessRepresentativeKind() != null)
            hcarLegalAccessTypeLegalAccess.setLegalAccessRepresentativeKind(org.libredemat.xml.request.social.HcarLegalAccessRepresentativeKindType.Enum.forString(getLegalAccessRepresentativeKind().getLegacyLabel()));
        ...
        if (getOtherBenefits() != null) {
            org.libredemat.xml.request.social.HcarOtherBenefitType[] otherBenefitsTypeTab = new org.libredemat.xml.request.social.HcarOtherBenefitType[getOtherBenefits().size()];
        ...
        if (getOtherFolders() != null) {
            org.libredemat.xml.request.social.HcarOtherFolderType[] otherFoldersTypeTab = new org.libredemat.xml.request.social.HcarOtherFolderType[getOtherFolders().size()];
        ...
        if (getPaymentAgencyBeneficiary() != null)
            hcarPaymentAgencyTypePaymentAgency.setPaymentAgencyBeneficiary(org.libredemat.xml.request.social.HcarPaymentAgencyBeneficiaryType.Enum.forString(getPaymentAgencyBeneficiary().getLegacyLabel()));
        ...
        if (getProfessionalStatusEnvironment() != null)
            hcarProfessionalStatusTypeProfessionalStatus.setProfessionalStatusEnvironment(org.libredemat.xml.request.social.HcarProfessionalStatusEnvironmentType.Enum.forString(getProfessionalStatusEnvironment().getLegacyLabel()));
        ...
        if (getProfessionalStatusKind() != null)
            hcarProfessionalStatusTypeProfessionalStatus.setProfessionalStatusKind(org.libredemat.xml.request.social.HcarProfessionalStatusKindType.Enum.forString(getProfessionalStatusKind().getLegacyLabel()));
        ...
        if (getProfessionals() != null) {
            org.libredemat.xml.request.social.HcarProfessionalType[] professionalsTypeTab = new org.libredemat.xml.request.social.HcarProfessionalType[getProfessionals().size()];
        ...
        if (getSocialSecurityMemberShipKind() != null)
            hcarSocialSecurityTypeSocialSecurity.setSocialSecurityMemberShipKind(org.libredemat.xml.request.social.HcarSocialSecurityMemberShipKindType.Enum.forString(getSocialSecurityMemberShipKind().getLegacyLabel()));
        ...
        if (getSubjectTitle() != null)
            hcarSubjectTypeHcarSubject.setSubjectTitle(org.libredemat.xml.common.TitleType.Enum.forString(getSubjectTitle().getLegacyLabel()));
    ...
    public static HandicapCompensationAdultRequest xmlToModel(HandicapCompensationAdultRequestDocument handicapCompensationAdultRequestDoc) {
        ...
        List<org.libredemat.business.request.social.HcarAdditionalFee> additionalFeeList = new ArrayList<org.libredemat.business.request.social.HcarAdditionalFee>(handicapCompensationAdultRequestXml.sizeOfAdditionalFeeArray());
        for (HcarAdditionalFeeType object : handicapCompensationAdultRequestXml.getAdditionalFeeArray()) {
            additionalFeeList.add(org.libredemat.business.request.social.HcarAdditionalFee.xmlToModel(object));
        }
        ...
        List<org.libredemat.business.request.social.HcarCareService> careServicesList = new ArrayList<org.libredemat.business.request.social.HcarCareService>(handicapCompensationAdultRequestXml.sizeOfCareServicesArray());
        for (HcarCareServiceType object : handicapCompensationAdultRequestXml.getCareServicesArray()) {
            careServicesList.add(org.libredemat.business.request.social.HcarCareService.xmlToModel(object));
        }
        ...
        if (handicapCompensationAdultRequestXml.getDwelling().getDwellingKind() != null)
            handicapCompensationAdultRequest.setDwellingKind(org.libredemat.business.request.social.HcarDwellingKindType.forString(handicapCompensationAdultRequestXml.getDwelling().getDwellingKind().toString()));
        else
            handicapCompensationAdultRequest.setDwellingKind(org.libredemat.business.request.social.HcarDwellingKindType.getDefaultHcarDwellingKindType());
        ...
        if (handicapCompensationAdultRequestXml.getDwelling().getDwellingReceptionType() != null)
            handicapCompensationAdultRequest.setDwellingReceptionType(org.libredemat.business.request.social.HcarDwellingReceptionKindType.forString(handicapCompensationAdultRequestXml.getDwelling().getDwellingReceptionType().toString()));
        else
            handicapCompensationAdultRequest.setDwellingReceptionType(org.libredemat.business.request.social.HcarDwellingReceptionKindType.getDefaultHcarDwellingReceptionKindType());
        ...
        List<org.libredemat.business.request.social.HcarFamilyAssistanceMember> familyAssistanceMembersList = new ArrayList<org.libredemat.business.request.social.HcarFamilyAssistanceMember>(handicapCompensationAdultRequestXml.sizeOfFamilyAssistanceMembersArray());
        for (HcarFamilyAssistanceMemberType object : handicapCompensationAdultRequestXml.getFamilyAssistanceMembersArray()) {
            familyAssistanceMembersList.add(org.libredemat.business.request.social.HcarFamilyAssistanceMember.xmlToModel(object));
        }
        handicapCompensationAdultRequest.setFamilyAssistanceMembers(familyAssistanceMembersList);
      
        List<org.libredemat.business.request.social.HcarFamilyDependent> familyDependentsList = new ArrayList<org.libredemat.business.request.social.HcarFamilyDependent>(handicapCompensationAdultRequestXml.sizeOfFamilyDependentsArray());
        for (HcarFamilyDependentType object : handicapCompensationAdultRequestXml.getFamilyDependentsArray()) {
            familyDependentsList.add(org.libredemat.business.request.social.HcarFamilyDependent.xmlToModel(object));
        }
        ...
        if (handicapCompensationAdultRequestXml.getFamily().getFamilyStatus() != null)
            handicapCompensationAdultRequest.setFamilyStatus(org.libredemat.business.users.FamilyStatusType.forString(handicapCompensationAdultRequestXml.getFamily().getFamilyStatus().toString()));
        else
            handicapCompensationAdultRequest.setFamilyStatus(org.libredemat.business.users.FamilyStatusType.getDefaultFamilyStatusType());
        ...
        List<org.libredemat.business.request.social.HcarHomeIntervenant> homeIntervenantsList = new ArrayList<org.libredemat.business.request.social.HcarHomeIntervenant>(handicapCompensationAdultRequestXml.sizeOfHomeIntervenantsArray());
        for (HcarHomeIntervenantType object : handicapCompensationAdultRequestXml.getHomeIntervenantsArray()) {
            homeIntervenantsList.add(org.libredemat.business.request.social.HcarHomeIntervenant.xmlToModel(object));
        }
        ...
        if (handicapCompensationAdultRequestXml.getLegalAccess().getLegalAccessKind() != null)
            handicapCompensationAdultRequest.setLegalAccessKind(org.libredemat.business.request.social.HcarLegalAccessKindType.forString(handicapCompensationAdultRequestXml.getLegalAccess().getLegalAccessKind().toString()));
        else
            handicapCompensationAdultRequest.setLegalAccessKind(org.libredemat.business.request.social.HcarLegalAccessKindType.getDefaultHcarLegalAccessKindType());
        ...
        if (handicapCompensationAdultRequestXml.getLegalAccess().getLegalAccessRepresentativeKind() != null)
            handicapCompensationAdultRequest.setLegalAccessRepresentativeKind(org.libredemat.business.request.social.HcarLegalAccessRepresentativeKindType.forString(handicapCompensationAdultRequestXml.getLegalAccess().getLegalAccessRepresentativeKind().toString()));
        else
            handicapCompensationAdultRequest.setLegalAccessRepresentativeKind(org.libredemat.business.request.social.HcarLegalAccessRepresentativeKindType.getDefaultHcarLegalAccessRepresentativeKindType());
        ...
        List<org.libredemat.business.request.social.HcarOtherBenefit> otherBenefitsList = new ArrayList<org.libredemat.business.request.social.HcarOtherBenefit>(handicapCompensationAdultRequestXml.sizeOfOtherBenefitsArray());
        for (HcarOtherBenefitType object : handicapCompensationAdultRequestXml.getOtherBenefitsArray()) {
            otherBenefitsList.add(org.libredemat.business.request.social.HcarOtherBenefit.xmlToModel(object));
        }
        handicapCompensationAdultRequest.setOtherBenefits(otherBenefitsList);
      
        List<org.libredemat.business.request.social.HcarOtherFolder> otherFoldersList = new ArrayList<org.libredemat.business.request.social.HcarOtherFolder>(handicapCompensationAdultRequestXml.sizeOfOtherFoldersArray());
        for (HcarOtherFolderType object : handicapCompensationAdultRequestXml.getOtherFoldersArray()) {
            otherFoldersList.add(org.libredemat.business.request.social.HcarOtherFolder.xmlToModel(object));
        }
        ...
        if (handicapCompensationAdultRequestXml.getPaymentAgency().getPaymentAgencyBeneficiary() != null)
            handicapCompensationAdultRequest.setPaymentAgencyBeneficiary(org.libredemat.business.request.social.HcarPaymentAgencyBeneficiaryType.forString(handicapCompensationAdultRequestXml.getPaymentAgency().getPaymentAgencyBeneficiary().toString()));
        else
            handicapCompensationAdultRequest.setPaymentAgencyBeneficiary(org.libredemat.business.request.social.HcarPaymentAgencyBeneficiaryType.getDefaultHcarPaymentAgencyBeneficiaryType());
        ...
        if (handicapCompensationAdultRequestXml.getProfessionalStatus().getProfessionalStatusEnvironment() != null)
            handicapCompensationAdultRequest.setProfessionalStatusEnvironment(org.libredemat.business.request.social.HcarProfessionalStatusEnvironmentType.forString(handicapCompensationAdultRequestXml.getProfessionalStatus().getProfessionalStatusEnvironment().toString()));
        else
            handicapCompensationAdultRequest.setProfessionalStatusEnvironment(org.libredemat.business.request.social.HcarProfessionalStatusEnvironmentType.getDefaultHcarProfessionalStatusEnvironmentType());
        ...
        if (handicapCompensationAdultRequestXml.getProfessionalStatus().getProfessionalStatusKind() != null)
            handicapCompensationAdultRequest.setProfessionalStatusKind(org.libredemat.business.request.social.HcarProfessionalStatusKindType.forString(handicapCompensationAdultRequestXml.getProfessionalStatus().getProfessionalStatusKind().toString()));
        else
            handicapCompensationAdultRequest.setProfessionalStatusKind(org.libredemat.business.request.social.HcarProfessionalStatusKindType.getDefaultHcarProfessionalStatusKindType());
        ...
        List<org.libredemat.business.request.social.HcarProfessional> professionalsList = new ArrayList<org.libredemat.business.request.social.HcarProfessional>(handicapCompensationAdultRequestXml.sizeOfProfessionalsArray());
        for (HcarProfessionalType object : handicapCompensationAdultRequestXml.getProfessionalsArray()) {
            professionalsList.add(org.libredemat.business.request.social.HcarProfessional.xmlToModel(object));
        }
        ...
        if (handicapCompensationAdultRequestXml.getSocialSecurity().getSocialSecurityMemberShipKind() != null)
            handicapCompensationAdultRequest.setSocialSecurityMemberShipKind(org.libredemat.business.request.social.HcarSocialSecurityMemberShipKindType.forString(handicapCompensationAdultRequestXml.getSocialSecurity().getSocialSecurityMemberShipKind().toString()));
        else
            handicapCompensationAdultRequest.setSocialSecurityMemberShipKind(org.libredemat.business.request.social.HcarSocialSecurityMemberShipKindType.getDefaultHcarSocialSecurityMemberShipKindType());
        ...
        if (handicapCompensationAdultRequestXml.getHcarSubject().getSubjectTitle() != null)
            handicapCompensationAdultRequest.setSubjectTitle(org.libredemat.business.users.TitleType.forString(handicapCompensationAdultRequestXml.getHcarSubject().getSubjectTitle().toString()));
        else
            handicapCompensationAdultRequest.setSubjectTitle(org.libredemat.business.users.TitleType.getDefaultTitleType());
    ...
    public final void setAdditionalFee(final List<org.libredemat.business.request.social.HcarAdditionalFee> additionalFee) {
        handicapCompensationAdultRequestData.setAdditionalFee(additionalFee);
    }

    
    public final List<org.libredemat.business.request.social.HcarAdditionalFee> getAdditionalFee() {
    ...
    public final void setCareServices(final List<org.libredemat.business.request.social.HcarCareService> careServices) {
        handicapCompensationAdultRequestData.setCareServices(careServices);
    }

    
    public final List<org.libredemat.business.request.social.HcarCareService> getCareServices() {
    ...
    public final void setDwellingKind(final org.libredemat.business.request.social.HcarDwellingKindType dwellingKind) {
        handicapCompensationAdultRequestData.setDwellingKind(dwellingKind);
    }

    
    public final org.libredemat.business.request.social.HcarDwellingKindType getDwellingKind() {
    ...
    public final void setDwellingReceptionType(final org.libredemat.business.request.social.HcarDwellingReceptionKindType dwellingReceptionType) {
        handicapCompensationAdultRequestData.setDwellingReceptionType(dwellingReceptionType);
    }

    
    public final org.libredemat.business.request.social.HcarDwellingReceptionKindType getDwellingReceptionType() {
    ...
    public final void setFamilyAssistanceMembers(final List<org.libredemat.business.request.social.HcarFamilyAssistanceMember> familyAssistanceMembers) {
        handicapCompensationAdultRequestData.setFamilyAssistanceMembers(familyAssistanceMembers);
    }

    
    public final List<org.libredemat.business.request.social.HcarFamilyAssistanceMember> getFamilyAssistanceMembers() {
        return handicapCompensationAdultRequestData.getFamilyAssistanceMembers();
    }
  
    public final void setFamilyDependents(final List<org.libredemat.business.request.social.HcarFamilyDependent> familyDependents) {
        handicapCompensationAdultRequestData.setFamilyDependents(familyDependents);
    }

    
    public final List<org.libredemat.business.request.social.HcarFamilyDependent> getFamilyDependents() {
    ...
    public final void setFamilyStatus(final org.libredemat.business.users.FamilyStatusType familyStatus) {
        handicapCompensationAdultRequestData.setFamilyStatus(familyStatus);
    }

    
    public final org.libredemat.business.users.FamilyStatusType getFamilyStatus() {
    ...
    public final void setHomeIntervenants(final List<org.libredemat.business.request.social.HcarHomeIntervenant> homeIntervenants) {
        handicapCompensationAdultRequestData.setHomeIntervenants(homeIntervenants);
    }

    
    public final List<org.libredemat.business.request.social.HcarHomeIntervenant> getHomeIntervenants() {
    ...
    public final void setLegalAccessKind(final org.libredemat.business.request.social.HcarLegalAccessKindType legalAccessKind) {
        handicapCompensationAdultRequestData.setLegalAccessKind(legalAccessKind);
    }

    
    public final org.libredemat.business.request.social.HcarLegalAccessKindType getLegalAccessKind() {
    ...
    public final void setLegalAccessRepresentativeKind(final org.libredemat.business.request.social.HcarLegalAccessRepresentativeKindType legalAccessRepresentativeKind) {
        handicapCompensationAdultRequestData.setLegalAccessRepresentativeKind(legalAccessRepresentativeKind);
    }

    
    public final org.libredemat.business.request.social.HcarLegalAccessRepresentativeKindType getLegalAccessRepresentativeKind() {
    ...
    public final void setOtherBenefits(final List<org.libredemat.business.request.social.HcarOtherBenefit> otherBenefits) {
        handicapCompensationAdultRequestData.setOtherBenefits(otherBenefits);
    }

    
    public final List<org.libredemat.business.request.social.HcarOtherBenefit> getOtherBenefits() {
        return handicapCompensationAdultRequestData.getOtherBenefits();
    }
  
    public final void setOtherFolders(final List<org.libredemat.business.request.social.HcarOtherFolder> otherFolders) {
        handicapCompensationAdultRequestData.setOtherFolders(otherFolders);
    }

    
    public final List<org.libredemat.business.request.social.HcarOtherFolder> getOtherFolders() {
    ...
    public final void setPaymentAgencyBeneficiary(final org.libredemat.business.request.social.HcarPaymentAgencyBeneficiaryType paymentAgencyBeneficiary) {
        handicapCompensationAdultRequestData.setPaymentAgencyBeneficiary(paymentAgencyBeneficiary);
    }

    
    public final org.libredemat.business.request.social.HcarPaymentAgencyBeneficiaryType getPaymentAgencyBeneficiary() {
    ...
    public final void setProfessionalStatusEnvironment(final org.libredemat.business.request.social.HcarProfessionalStatusEnvironmentType professionalStatusEnvironment) {
        handicapCompensationAdultRequestData.setProfessionalStatusEnvironment(professionalStatusEnvironment);
    }

    
    public final org.libredemat.business.request.social.HcarProfessionalStatusEnvironmentType getProfessionalStatusEnvironment() {
    ...
    public final void setProfessionalStatusKind(final org.libredemat.business.request.social.HcarProfessionalStatusKindType professionalStatusKind) {
        handicapCompensationAdultRequestData.setProfessionalStatusKind(professionalStatusKind);
    }

    
    public final org.libredemat.business.request.social.HcarProfessionalStatusKindType getProfessionalStatusKind() {
    ...
    public final void setProfessionalSupportSocialServiceAddress(final org.libredemat.business.users.Address professionalSupportSocialServiceAddress) {
        handicapCompensationAdultRequestData.setProfessionalSupportSocialServiceAddress(professionalSupportSocialServiceAddress);
    }

    
    public final org.libredemat.business.users.Address getProfessionalSupportSocialServiceAddress() {
    ...
    public final void setProfessionals(final List<org.libredemat.business.request.social.HcarProfessional> professionals) {
        handicapCompensationAdultRequestData.setProfessionals(professionals);
    }

    
    public final List<org.libredemat.business.request.social.HcarProfessional> getProfessionals() {
    ...
    public final void setSocialSecurityMemberShipKind(final org.libredemat.business.request.social.HcarSocialSecurityMemberShipKindType socialSecurityMemberShipKind) {
        handicapCompensationAdultRequestData.setSocialSecurityMemberShipKind(socialSecurityMemberShipKind);
    }

    
    public final org.libredemat.business.request.social.HcarSocialSecurityMemberShipKindType getSocialSecurityMemberShipKind() {
    ...
    public final void setSubjectTitle(final org.libredemat.business.users.TitleType subjectTitle) {
        handicapCompensationAdultRequestData.setSubjectTitle(subjectTitle);
    }

    
    public final org.libredemat.business.users.TitleType getSubjectTitle() {
