...
public class SagrMembreBureau implements Serializable {
    ...
    public final SagrMembreBureauType modelToXml() {
        ...
        if (this.roleMembre != null)
            sagrMembreBureau.setRoleMembre(org.libredemat.xml.request.social.SagrRoleAutreMembreAssociationType.Enum.forString(this.roleMembre.getLegacyLabel()));
    ...
    public static SagrMembreBureau xmlToModel(SagrMembreBureauType sagrMembreBureauDoc) {
        ...
        if (sagrMembreBureauDoc.getRoleMembre() != null)
            sagrMembreBureau.setRoleMembre(org.libredemat.business.request.social.SagrRoleAutreMembreAssociationType.forString(sagrMembreBureauDoc.getRoleMembre().toString()));
        else
            sagrMembreBureau.setRoleMembre(org.libredemat.business.request.social.SagrRoleAutreMembreAssociationType.getDefaultSagrRoleAutreMembreAssociationType());
    ...
    public SagrMembreBureau clone() {
        ...
        if (roleMembre != null)
            ...
            result.setRoleMembre(org.libredemat.business.request.social.SagrRoleAutreMembreAssociationType.getDefaultSagrRoleAutreMembreAssociationType());
    ...
    private org.libredemat.business.request.social.SagrRoleAutreMembreAssociationType roleMembre;

    public void setRoleMembre(final org.libredemat.business.request.social.SagrRoleAutreMembreAssociationType roleMembre) {
    ...
    public org.libredemat.business.request.social.SagrRoleAutreMembreAssociationType getRoleMembre() {
