...
public class SportsAssociationsGrantRequest extends Request implements Serializable {
    ...
    public final SportsAssociationsGrantRequestDocument modelToXml() {
        ...
        if (getAutreMembreBureau() != null) {
            org.libredemat.xml.request.social.SagrMembreBureauType[] autreMembreBureauTypeTab = new org.libredemat.xml.request.social.SagrMembreBureauType[getAutreMembreBureau().size()];
        ...
        if (getRoleDemandeur() != null)
            sportsAssociationsGrantRequest.setRoleDemandeur(org.libredemat.xml.request.social.SagrRoleAssociationType.Enum.forString(getRoleDemandeur().getLegacyLabel()));
      
        i = 0;
        if (getSagrActiviteAssociation() != null) {
            org.libredemat.xml.request.social.SagrActiviteAssociationType[] sagrActiviteAssociationTypeTab = new org.libredemat.xml.request.social.SagrActiviteAssociationType[getSagrActiviteAssociation().size()];
    ...
    public static SportsAssociationsGrantRequest xmlToModel(SportsAssociationsGrantRequestDocument sportsAssociationsGrantRequestDoc) {
        ...
        List<org.libredemat.business.request.social.SagrMembreBureau> autreMembreBureauList = new ArrayList<org.libredemat.business.request.social.SagrMembreBureau>(sportsAssociationsGrantRequestXml.sizeOfAutreMembreBureauArray());
        for (SagrMembreBureauType object : sportsAssociationsGrantRequestXml.getAutreMembreBureauArray()) {
            autreMembreBureauList.add(org.libredemat.business.request.social.SagrMembreBureau.xmlToModel(object));
        }
        ...
        if (sportsAssociationsGrantRequestXml.getRoleDemandeur() != null)
            sportsAssociationsGrantRequest.setRoleDemandeur(org.libredemat.business.request.social.SagrRoleAssociationType.forString(sportsAssociationsGrantRequestXml.getRoleDemandeur().toString()));
        else
            sportsAssociationsGrantRequest.setRoleDemandeur(org.libredemat.business.request.social.SagrRoleAssociationType.getDefaultSagrRoleAssociationType());
      
        List<org.libredemat.business.request.social.SagrActiviteAssociation> sagrActiviteAssociationList = new ArrayList<org.libredemat.business.request.social.SagrActiviteAssociation>(sportsAssociationsGrantRequestXml.sizeOfSagrActiviteAssociationArray());
        for (SagrActiviteAssociationType object : sportsAssociationsGrantRequestXml.getSagrActiviteAssociationArray()) {
            sagrActiviteAssociationList.add(org.libredemat.business.request.social.SagrActiviteAssociation.xmlToModel(object));
        }
    ...
    public final void setAdresseCorrespondantPrincipal(final org.libredemat.business.users.Address adresseCorrespondantPrincipal) {
        sportsAssociationsGrantRequestData.setAdresseCorrespondantPrincipal(adresseCorrespondantPrincipal);
    }

    
    public final org.libredemat.business.users.Address getAdresseCorrespondantPrincipal() {
        return sportsAssociationsGrantRequestData.getAdresseCorrespondantPrincipal();
    }
  
    public final void setAutreMembreBureau(final List<org.libredemat.business.request.social.SagrMembreBureau> autreMembreBureau) {
        sportsAssociationsGrantRequestData.setAutreMembreBureau(autreMembreBureau);
    }

    
    public final List<org.libredemat.business.request.social.SagrMembreBureau> getAutreMembreBureau() {
    ...
    public final void setCompteBancaire(final org.libredemat.business.users.BankAccount compteBancaire) {
        sportsAssociationsGrantRequestData.setCompteBancaire(compteBancaire);
    }

    
    public final org.libredemat.business.users.BankAccount getCompteBancaire() {
    ...
    public final void setRoleDemandeur(final org.libredemat.business.request.social.SagrRoleAssociationType roleDemandeur) {
        sportsAssociationsGrantRequestData.setRoleDemandeur(roleDemandeur);
    }

    
    public final org.libredemat.business.request.social.SagrRoleAssociationType getRoleDemandeur() {
        return sportsAssociationsGrantRequestData.getRoleDemandeur();
    }
  
    public final void setSagrActiviteAssociation(final List<org.libredemat.business.request.social.SagrActiviteAssociation> sagrActiviteAssociation) {
        sportsAssociationsGrantRequestData.setSagrActiviteAssociation(sagrActiviteAssociation);
    }

    
    public final List<org.libredemat.business.request.social.SagrActiviteAssociation> getSagrActiviteAssociation() {
        return sportsAssociationsGrantRequestData.getSagrActiviteAssociation();
    }
  
    public final void setSiegeSocialAssociation(final org.libredemat.business.users.Address siegeSocialAssociation) {
        sportsAssociationsGrantRequestData.setSiegeSocialAssociation(siegeSocialAssociation);
    }

    
    public final org.libredemat.business.users.Address getSiegeSocialAssociation() {
