...
public class DhrNotRealAsset implements Serializable {
    ...
    public final DhrNotRealAssetType modelToXml() {
        ...
        if (this.dhrNotRealAssetType != null)
            dhrNotRealAsset.setDhrNotRealAssetType(org.libredemat.xml.request.social.DhrAssetTypeType.Enum.forString(this.dhrNotRealAssetType.getLegacyLabel()));
        ...
        if (this.dhrNotRealAssetKind != null)
            dhrNotRealAsset.setDhrNotRealAssetKind(org.libredemat.xml.request.social.DhrAssetKindType.Enum.forString(this.dhrNotRealAssetKind.getLegacyLabel()));
    ...
    public static DhrNotRealAsset xmlToModel(DhrNotRealAssetType dhrNotRealAssetDoc) {
        ...
        if (dhrNotRealAssetDoc.getDhrNotRealAssetType() != null)
            dhrNotRealAsset.setDhrNotRealAssetType(org.libredemat.business.request.social.DhrAssetTypeType.forString(dhrNotRealAssetDoc.getDhrNotRealAssetType().toString()));
        else
            dhrNotRealAsset.setDhrNotRealAssetType(org.libredemat.business.request.social.DhrAssetTypeType.getDefaultDhrAssetTypeType());
        ...
        if (dhrNotRealAssetDoc.getDhrNotRealAssetKind() != null)
            dhrNotRealAsset.setDhrNotRealAssetKind(org.libredemat.business.request.social.DhrAssetKindType.forString(dhrNotRealAssetDoc.getDhrNotRealAssetKind().toString()));
        else
            dhrNotRealAsset.setDhrNotRealAssetKind(org.libredemat.business.request.social.DhrAssetKindType.getDefaultDhrAssetKindType());
    ...
    public DhrNotRealAsset clone() {
        ...
        if (dhrNotRealAssetType != null)
            ...
            result.setDhrNotRealAssetType(org.libredemat.business.request.social.DhrAssetTypeType.getDefaultDhrAssetTypeType());
        ...
        if (dhrNotRealAssetKind != null)
            ...
            result.setDhrNotRealAssetKind(org.libredemat.business.request.social.DhrAssetKindType.getDefaultDhrAssetKindType());
    ...
    private org.libredemat.business.users.Address dhrNotRealAssetAddress;

    public void setDhrNotRealAssetAddress(final org.libredemat.business.users.Address dhrNotRealAssetAddress) {
    ...
    public org.libredemat.business.users.Address getDhrNotRealAssetAddress() {
    ...
    private org.libredemat.business.request.social.DhrAssetTypeType dhrNotRealAssetType;

    public void setDhrNotRealAssetType(final org.libredemat.business.request.social.DhrAssetTypeType dhrNotRealAssetType) {
    ...
    public org.libredemat.business.request.social.DhrAssetTypeType getDhrNotRealAssetType() {
    ...
    private org.libredemat.business.users.Address dhrNotRealAssetBeneficiaryAddress;

    public void setDhrNotRealAssetBeneficiaryAddress(final org.libredemat.business.users.Address dhrNotRealAssetBeneficiaryAddress) {
    ...
    public org.libredemat.business.users.Address getDhrNotRealAssetBeneficiaryAddress() {
    ...
    private org.libredemat.business.users.Address dhrNotRealAssetNotaryAddress;

    public void setDhrNotRealAssetNotaryAddress(final org.libredemat.business.users.Address dhrNotRealAssetNotaryAddress) {
    ...
    public org.libredemat.business.users.Address getDhrNotRealAssetNotaryAddress() {
    ...
    private org.libredemat.business.request.social.DhrAssetKindType dhrNotRealAssetKind;

    public void setDhrNotRealAssetKind(final org.libredemat.business.request.social.DhrAssetKindType dhrNotRealAssetKind) {
    ...
    public org.libredemat.business.request.social.DhrAssetKindType getDhrNotRealAssetKind() {
