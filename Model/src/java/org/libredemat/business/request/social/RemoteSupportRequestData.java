...
public class RemoteSupportRequestData implements Serializable {
    ...
    public RemoteSupportRequestData() {
        ...
        contactKind = org.libredemat.business.request.social.RsrContactKindType.REQUESTER;
      
        requestInformationEmergency = Boolean.valueOf(false);
      
        requestInformationRequestKind = org.libredemat.business.request.social.RsrRequestInformationRequestKindType.INDIVIDUAL;
        ...
        subjectResideWith = org.libredemat.business.request.social.RsrSubjectResideWithType.ALONE;
    ...
    public RemoteSupportRequestData clone() {
        ...
        if (contactKind != null)
            ...
            result.setContactKind(org.libredemat.business.request.social.RsrContactKindType.getDefaultRsrContactKindType());
        ...
        if (requestInformationRequestKind != null)
            ...
            result.setRequestInformationRequestKind(org.libredemat.business.request.social.RsrRequestInformationRequestKindType.getDefaultRsrRequestInformationRequestKindType());
        ...
        if (spouseTitle != null)
            ...
            result.setSpouseTitle(org.libredemat.business.users.TitleType.getDefaultTitleType());
        ...
        if (subjectResideWith != null)
            ...
            result.setSubjectResideWith(org.libredemat.business.request.social.RsrSubjectResideWithType.getDefaultRsrSubjectResideWithType());
    ...
    private org.libredemat.business.request.social.RsrContactKindType contactKind;

    public void setContactKind(final org.libredemat.business.request.social.RsrContactKindType contactKind) {
    ...
    public org.libredemat.business.request.social.RsrContactKindType getContactKind() {
    ...
    private org.libredemat.business.request.social.RsrRequestInformationRequestKindType requestInformationRequestKind;

    public void setRequestInformationRequestKind(final org.libredemat.business.request.social.RsrRequestInformationRequestKindType requestInformationRequestKind) {
    ...
    public org.libredemat.business.request.social.RsrRequestInformationRequestKindType getRequestInformationRequestKind() {
    ...
    private org.libredemat.business.users.TitleType spouseTitle;

    public void setSpouseTitle(final org.libredemat.business.users.TitleType spouseTitle) {
    ...
    public org.libredemat.business.users.TitleType getSpouseTitle() {
    ...
    private org.libredemat.business.request.social.RsrSubjectResideWithType subjectResideWith;

    public void setSubjectResideWith(final org.libredemat.business.request.social.RsrSubjectResideWithType subjectResideWith) {
    ...
    public org.libredemat.business.request.social.RsrSubjectResideWithType getSubjectResideWith() {
