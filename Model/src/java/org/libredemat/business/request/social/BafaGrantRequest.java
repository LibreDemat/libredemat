...
public class BafaGrantRequest extends Request implements Serializable {
    ...
    public final BafaGrantRequestDocument modelToXml() {
        ...
        if (getAccountHolderTitle() != null)
            bafaGrantRequest.setAccountHolderTitle(org.libredemat.xml.common.TitleType.Enum.forString(getAccountHolderTitle().getLegacyLabel()));
    ...
    public static BafaGrantRequest xmlToModel(BafaGrantRequestDocument bafaGrantRequestDoc) {
        ...
        if (bafaGrantRequestXml.getAccountHolderTitle() != null)
            bafaGrantRequest.setAccountHolderTitle(org.libredemat.business.users.TitleType.forString(bafaGrantRequestXml.getAccountHolderTitle().toString()));
        else
            bafaGrantRequest.setAccountHolderTitle(org.libredemat.business.users.TitleType.getDefaultTitleType());
    ...
    public final void setInternshipInstituteAddress(final org.libredemat.business.users.Address internshipInstituteAddress) {
        bafaGrantRequestData.setInternshipInstituteAddress(internshipInstituteAddress);
    }

    
    public final org.libredemat.business.users.Address getInternshipInstituteAddress() {
