...
public class HccrProfessional implements Serializable {
    ...
    private org.libredemat.business.users.Address professionalAddress;

    public void setProfessionalAddress(final org.libredemat.business.users.Address professionalAddress) {
    ...
    public org.libredemat.business.users.Address getProfessionalAddress() {
