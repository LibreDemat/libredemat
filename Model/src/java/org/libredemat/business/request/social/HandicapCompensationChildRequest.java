...
public class HandicapCompensationChildRequest extends Request implements Serializable {
    ...
    public final HandicapCompensationChildRequestDocument modelToXml() {
        ...
        if (getAdditionalFee() != null) {
            org.libredemat.xml.request.social.HccrAdditionalFeeType[] additionalFeeTypeTab = new org.libredemat.xml.request.social.HccrAdditionalFeeType[getAdditionalFee().size()];
        ...
        if (getCareServices() != null) {
            org.libredemat.xml.request.social.HccrCareServiceType[] careServicesTypeTab = new org.libredemat.xml.request.social.HccrCareServiceType[getCareServices().size()];
        ...
        if (getDwellingKind() != null)
            hccrDwellingTypeDwelling.setDwellingKind(org.libredemat.xml.request.social.HccrDwellingKindType.Enum.forString(getDwellingKind().getLegacyLabel()));
        ...
        if (getDwellingReceptionType() != null)
            hccrDwellingTypeDwelling.setDwellingReceptionType(org.libredemat.xml.request.social.HccrDwellingReceptionKindType.Enum.forString(getDwellingReceptionType().getLegacyLabel()));
        ...
        if (getFamilyAssistanceMembers() != null) {
            org.libredemat.xml.request.social.HccrFamilyAssistanceMemberType[] familyAssistanceMembersTypeTab = new org.libredemat.xml.request.social.HccrFamilyAssistanceMemberType[getFamilyAssistanceMembers().size()];
        ...
        if (getFamilyDependents() != null) {
            org.libredemat.xml.request.social.HccrFamilyDependentType[] familyDependentsTypeTab = new org.libredemat.xml.request.social.HccrFamilyDependentType[getFamilyDependents().size()];
        ...
        if (getHomeIntervenants() != null) {
            org.libredemat.xml.request.social.HccrHomeIntervenantType[] homeIntervenantsTypeTab = new org.libredemat.xml.request.social.HccrHomeIntervenantType[getHomeIntervenants().size()];
        ...
        if (getOtherBenefits() != null) {
            org.libredemat.xml.request.social.HccrOtherBenefitType[] otherBenefitsTypeTab = new org.libredemat.xml.request.social.HccrOtherBenefitType[getOtherBenefits().size()];
        ...
        if (getOtherFolders() != null) {
            org.libredemat.xml.request.social.HccrOtherFolderType[] otherFoldersTypeTab = new org.libredemat.xml.request.social.HccrOtherFolderType[getOtherFolders().size()];
        ...
        if (getPaymentAgencyBeneficiary() != null)
            hccrPaymentAgencyTypePaymentAgency.setPaymentAgencyBeneficiary(org.libredemat.xml.request.social.HccrPaymentAgencyBeneficiaryType.Enum.forString(getPaymentAgencyBeneficiary().getLegacyLabel()));
        ...
        if (getProfessionalStatusEnvironment() != null)
            hccrProfessionalStatusTypeProfessionalStatus.setProfessionalStatusEnvironment(org.libredemat.xml.request.social.HccrProfessionalStatusEnvironmentType.Enum.forString(getProfessionalStatusEnvironment().getLegacyLabel()));
        ...
        if (getProfessionalStatusKind() != null)
            hccrProfessionalStatusTypeProfessionalStatus.setProfessionalStatusKind(org.libredemat.xml.request.social.HccrProfessionalStatusKindType.Enum.forString(getProfessionalStatusKind().getLegacyLabel()));
        ...
        if (getProfessionals() != null) {
            org.libredemat.xml.request.social.HccrProfessionalType[] professionalsTypeTab = new org.libredemat.xml.request.social.HccrProfessionalType[getProfessionals().size()];
        ...
        if (getReferentFamilyStatus() != null)
            hccrReferentReferent.setReferentFamilyStatus(org.libredemat.xml.common.FamilyStatusType.Enum.forString(getReferentFamilyStatus().getLegacyLabel()));
        ...
        if (getReferentTitle() != null)
            hccrReferentReferent.setReferentTitle(org.libredemat.xml.common.TitleType.Enum.forString(getReferentTitle().getLegacyLabel()));
        ...
        if (getSchoolingAttendedGrade() != null)
            hccrSchoolingTypeSchooling.setSchoolingAttendedGrade(org.libredemat.xml.common.SectionType.Enum.forString(getSchoolingAttendedGrade().getLegacyLabel()));
        ...
        if (getSchoolingHomeSchoolingKind() != null)
            hccrSchoolingTypeSchooling.setSchoolingHomeSchoolingKind(org.libredemat.xml.request.social.HccrHomeSchoolingKindType.Enum.forString(getSchoolingHomeSchoolingKind().getLegacyLabel()));
        ...
        if (getSchoolingSchoolingKind() != null)
            hccrSchoolingTypeSchooling.setSchoolingSchoolingKind(org.libredemat.xml.request.social.HccrSchoolingKindType.Enum.forString(getSchoolingSchoolingKind().getLegacyLabel()));
        ...
        if (getSocialSecurityMemberShipKind() != null)
            hccrSocialSecurityTypeSocialSecurity.setSocialSecurityMemberShipKind(org.libredemat.xml.request.social.HccrSocialSecurityMemberShipKindType.Enum.forString(getSocialSecurityMemberShipKind().getLegacyLabel()));
        ...
        if (getSubjectParentalAuthorityHolder() != null)
            hccrSubjectTypeHccrSubject.setSubjectParentalAuthorityHolder(org.libredemat.xml.request.social.HccrSubjectParentalAuthorityHolderType.Enum.forString(getSubjectParentalAuthorityHolder().getLegacyLabel()));
    ...
    public static HandicapCompensationChildRequest xmlToModel(HandicapCompensationChildRequestDocument handicapCompensationChildRequestDoc) {
        ...
        List<org.libredemat.business.request.social.HccrAdditionalFee> additionalFeeList = new ArrayList<org.libredemat.business.request.social.HccrAdditionalFee>(handicapCompensationChildRequestXml.sizeOfAdditionalFeeArray());
        for (HccrAdditionalFeeType object : handicapCompensationChildRequestXml.getAdditionalFeeArray()) {
            additionalFeeList.add(org.libredemat.business.request.social.HccrAdditionalFee.xmlToModel(object));
        }
        ...
        List<org.libredemat.business.request.social.HccrCareService> careServicesList = new ArrayList<org.libredemat.business.request.social.HccrCareService>(handicapCompensationChildRequestXml.sizeOfCareServicesArray());
        for (HccrCareServiceType object : handicapCompensationChildRequestXml.getCareServicesArray()) {
            careServicesList.add(org.libredemat.business.request.social.HccrCareService.xmlToModel(object));
        }
        ...
        if (handicapCompensationChildRequestXml.getDwelling().getDwellingKind() != null)
            handicapCompensationChildRequest.setDwellingKind(org.libredemat.business.request.social.HccrDwellingKindType.forString(handicapCompensationChildRequestXml.getDwelling().getDwellingKind().toString()));
        else
            handicapCompensationChildRequest.setDwellingKind(org.libredemat.business.request.social.HccrDwellingKindType.getDefaultHccrDwellingKindType());
        ...
        if (handicapCompensationChildRequestXml.getDwelling().getDwellingReceptionType() != null)
            handicapCompensationChildRequest.setDwellingReceptionType(org.libredemat.business.request.social.HccrDwellingReceptionKindType.forString(handicapCompensationChildRequestXml.getDwelling().getDwellingReceptionType().toString()));
        else
            handicapCompensationChildRequest.setDwellingReceptionType(org.libredemat.business.request.social.HccrDwellingReceptionKindType.getDefaultHccrDwellingReceptionKindType());
        ...
        List<org.libredemat.business.request.social.HccrFamilyAssistanceMember> familyAssistanceMembersList = new ArrayList<org.libredemat.business.request.social.HccrFamilyAssistanceMember>(handicapCompensationChildRequestXml.sizeOfFamilyAssistanceMembersArray());
        for (HccrFamilyAssistanceMemberType object : handicapCompensationChildRequestXml.getFamilyAssistanceMembersArray()) {
            familyAssistanceMembersList.add(org.libredemat.business.request.social.HccrFamilyAssistanceMember.xmlToModel(object));
        }
        handicapCompensationChildRequest.setFamilyAssistanceMembers(familyAssistanceMembersList);
      
        List<org.libredemat.business.request.social.HccrFamilyDependent> familyDependentsList = new ArrayList<org.libredemat.business.request.social.HccrFamilyDependent>(handicapCompensationChildRequestXml.sizeOfFamilyDependentsArray());
        for (HccrFamilyDependentType object : handicapCompensationChildRequestXml.getFamilyDependentsArray()) {
            familyDependentsList.add(org.libredemat.business.request.social.HccrFamilyDependent.xmlToModel(object));
        }
        ...
        List<org.libredemat.business.request.social.HccrHomeIntervenant> homeIntervenantsList = new ArrayList<org.libredemat.business.request.social.HccrHomeIntervenant>(handicapCompensationChildRequestXml.sizeOfHomeIntervenantsArray());
        for (HccrHomeIntervenantType object : handicapCompensationChildRequestXml.getHomeIntervenantsArray()) {
            homeIntervenantsList.add(org.libredemat.business.request.social.HccrHomeIntervenant.xmlToModel(object));
        }
        ...
        List<org.libredemat.business.request.social.HccrOtherBenefit> otherBenefitsList = new ArrayList<org.libredemat.business.request.social.HccrOtherBenefit>(handicapCompensationChildRequestXml.sizeOfOtherBenefitsArray());
        for (HccrOtherBenefitType object : handicapCompensationChildRequestXml.getOtherBenefitsArray()) {
            otherBenefitsList.add(org.libredemat.business.request.social.HccrOtherBenefit.xmlToModel(object));
        }
        handicapCompensationChildRequest.setOtherBenefits(otherBenefitsList);
      
        List<org.libredemat.business.request.social.HccrOtherFolder> otherFoldersList = new ArrayList<org.libredemat.business.request.social.HccrOtherFolder>(handicapCompensationChildRequestXml.sizeOfOtherFoldersArray());
        for (HccrOtherFolderType object : handicapCompensationChildRequestXml.getOtherFoldersArray()) {
            otherFoldersList.add(org.libredemat.business.request.social.HccrOtherFolder.xmlToModel(object));
        }
        ...
        if (handicapCompensationChildRequestXml.getPaymentAgency().getPaymentAgencyBeneficiary() != null)
            handicapCompensationChildRequest.setPaymentAgencyBeneficiary(org.libredemat.business.request.social.HccrPaymentAgencyBeneficiaryType.forString(handicapCompensationChildRequestXml.getPaymentAgency().getPaymentAgencyBeneficiary().toString()));
        else
            handicapCompensationChildRequest.setPaymentAgencyBeneficiary(org.libredemat.business.request.social.HccrPaymentAgencyBeneficiaryType.getDefaultHccrPaymentAgencyBeneficiaryType());
        ...
        if (handicapCompensationChildRequestXml.getProfessionalStatus().getProfessionalStatusEnvironment() != null)
            handicapCompensationChildRequest.setProfessionalStatusEnvironment(org.libredemat.business.request.social.HccrProfessionalStatusEnvironmentType.forString(handicapCompensationChildRequestXml.getProfessionalStatus().getProfessionalStatusEnvironment().toString()));
        else
            handicapCompensationChildRequest.setProfessionalStatusEnvironment(org.libredemat.business.request.social.HccrProfessionalStatusEnvironmentType.getDefaultHccrProfessionalStatusEnvironmentType());
        ...
        if (handicapCompensationChildRequestXml.getProfessionalStatus().getProfessionalStatusKind() != null)
            handicapCompensationChildRequest.setProfessionalStatusKind(org.libredemat.business.request.social.HccrProfessionalStatusKindType.forString(handicapCompensationChildRequestXml.getProfessionalStatus().getProfessionalStatusKind().toString()));
        else
            handicapCompensationChildRequest.setProfessionalStatusKind(org.libredemat.business.request.social.HccrProfessionalStatusKindType.getDefaultHccrProfessionalStatusKindType());
        ...
        List<org.libredemat.business.request.social.HccrProfessional> professionalsList = new ArrayList<org.libredemat.business.request.social.HccrProfessional>(handicapCompensationChildRequestXml.sizeOfProfessionalsArray());
        for (HccrProfessionalType object : handicapCompensationChildRequestXml.getProfessionalsArray()) {
            professionalsList.add(org.libredemat.business.request.social.HccrProfessional.xmlToModel(object));
        }
        ...
        if (handicapCompensationChildRequestXml.getReferent().getReferentFamilyStatus() != null)
            handicapCompensationChildRequest.setReferentFamilyStatus(org.libredemat.business.users.FamilyStatusType.forString(handicapCompensationChildRequestXml.getReferent().getReferentFamilyStatus().toString()));
        else
            handicapCompensationChildRequest.setReferentFamilyStatus(org.libredemat.business.users.FamilyStatusType.getDefaultFamilyStatusType());
        ...
        if (handicapCompensationChildRequestXml.getReferent().getReferentTitle() != null)
            handicapCompensationChildRequest.setReferentTitle(org.libredemat.business.users.TitleType.forString(handicapCompensationChildRequestXml.getReferent().getReferentTitle().toString()));
        else
            handicapCompensationChildRequest.setReferentTitle(org.libredemat.business.users.TitleType.getDefaultTitleType());
      
        if (handicapCompensationChildRequestXml.getSchooling().getSchoolingAttendedGrade() != null)
            handicapCompensationChildRequest.setSchoolingAttendedGrade(org.libredemat.business.users.SectionType.forString(handicapCompensationChildRequestXml.getSchooling().getSchoolingAttendedGrade().toString()));
        else
            handicapCompensationChildRequest.setSchoolingAttendedGrade(org.libredemat.business.users.SectionType.getDefaultSectionType());
        ...
        if (handicapCompensationChildRequestXml.getSchooling().getSchoolingHomeSchoolingKind() != null)
            handicapCompensationChildRequest.setSchoolingHomeSchoolingKind(org.libredemat.business.request.social.HccrHomeSchoolingKindType.forString(handicapCompensationChildRequestXml.getSchooling().getSchoolingHomeSchoolingKind().toString()));
        else
            handicapCompensationChildRequest.setSchoolingHomeSchoolingKind(org.libredemat.business.request.social.HccrHomeSchoolingKindType.getDefaultHccrHomeSchoolingKindType());
        ...
        if (handicapCompensationChildRequestXml.getSchooling().getSchoolingSchoolingKind() != null)
            handicapCompensationChildRequest.setSchoolingSchoolingKind(org.libredemat.business.request.social.HccrSchoolingKindType.forString(handicapCompensationChildRequestXml.getSchooling().getSchoolingSchoolingKind().toString()));
        else
            handicapCompensationChildRequest.setSchoolingSchoolingKind(org.libredemat.business.request.social.HccrSchoolingKindType.getDefaultHccrSchoolingKindType());
        ...
        if (handicapCompensationChildRequestXml.getSocialSecurity().getSocialSecurityMemberShipKind() != null)
            handicapCompensationChildRequest.setSocialSecurityMemberShipKind(org.libredemat.business.request.social.HccrSocialSecurityMemberShipKindType.forString(handicapCompensationChildRequestXml.getSocialSecurity().getSocialSecurityMemberShipKind().toString()));
        else
            handicapCompensationChildRequest.setSocialSecurityMemberShipKind(org.libredemat.business.request.social.HccrSocialSecurityMemberShipKindType.getDefaultHccrSocialSecurityMemberShipKindType());
        ...
        if (handicapCompensationChildRequestXml.getHccrSubject().getSubjectParentalAuthorityHolder() != null)
            handicapCompensationChildRequest.setSubjectParentalAuthorityHolder(org.libredemat.business.request.social.HccrSubjectParentalAuthorityHolderType.forString(handicapCompensationChildRequestXml.getHccrSubject().getSubjectParentalAuthorityHolder().toString()));
        else
            handicapCompensationChildRequest.setSubjectParentalAuthorityHolder(org.libredemat.business.request.social.HccrSubjectParentalAuthorityHolderType.getDefaultHccrSubjectParentalAuthorityHolderType());
    ...
    public final void setAdditionalFee(final List<org.libredemat.business.request.social.HccrAdditionalFee> additionalFee) {
        handicapCompensationChildRequestData.setAdditionalFee(additionalFee);
    }

    
    public final List<org.libredemat.business.request.social.HccrAdditionalFee> getAdditionalFee() {
    ...
    public final void setCareServices(final List<org.libredemat.business.request.social.HccrCareService> careServices) {
        handicapCompensationChildRequestData.setCareServices(careServices);
    }

    
    public final List<org.libredemat.business.request.social.HccrCareService> getCareServices() {
    ...
    public final void setDwellingKind(final org.libredemat.business.request.social.HccrDwellingKindType dwellingKind) {
        handicapCompensationChildRequestData.setDwellingKind(dwellingKind);
    }

    
    public final org.libredemat.business.request.social.HccrDwellingKindType getDwellingKind() {
    ...
    public final void setDwellingReceptionAddress(final org.libredemat.business.users.Address dwellingReceptionAddress) {
        handicapCompensationChildRequestData.setDwellingReceptionAddress(dwellingReceptionAddress);
    }

    
    public final org.libredemat.business.users.Address getDwellingReceptionAddress() {
    ...
    public final void setDwellingReceptionType(final org.libredemat.business.request.social.HccrDwellingReceptionKindType dwellingReceptionType) {
        handicapCompensationChildRequestData.setDwellingReceptionType(dwellingReceptionType);
    }

    
    public final org.libredemat.business.request.social.HccrDwellingReceptionKindType getDwellingReceptionType() {
    ...
    public final void setDwellingSocialReceptionAddress(final org.libredemat.business.users.Address dwellingSocialReceptionAddress) {
        handicapCompensationChildRequestData.setDwellingSocialReceptionAddress(dwellingSocialReceptionAddress);
    }

    
    public final org.libredemat.business.users.Address getDwellingSocialReceptionAddress() {
    ...
    public final void setFamilyAssistanceMembers(final List<org.libredemat.business.request.social.HccrFamilyAssistanceMember> familyAssistanceMembers) {
        handicapCompensationChildRequestData.setFamilyAssistanceMembers(familyAssistanceMembers);
    }

    
    public final List<org.libredemat.business.request.social.HccrFamilyAssistanceMember> getFamilyAssistanceMembers() {
        return handicapCompensationChildRequestData.getFamilyAssistanceMembers();
    }
  
    public final void setFamilyDependents(final List<org.libredemat.business.request.social.HccrFamilyDependent> familyDependents) {
        handicapCompensationChildRequestData.setFamilyDependents(familyDependents);
    }

    
    public final List<org.libredemat.business.request.social.HccrFamilyDependent> getFamilyDependents() {
    ...
    public final void setHomeIntervenants(final List<org.libredemat.business.request.social.HccrHomeIntervenant> homeIntervenants) {
        handicapCompensationChildRequestData.setHomeIntervenants(homeIntervenants);
    }

    
    public final List<org.libredemat.business.request.social.HccrHomeIntervenant> getHomeIntervenants() {
    ...
    public final void setOtherBenefits(final List<org.libredemat.business.request.social.HccrOtherBenefit> otherBenefits) {
        handicapCompensationChildRequestData.setOtherBenefits(otherBenefits);
    }

    
    public final List<org.libredemat.business.request.social.HccrOtherBenefit> getOtherBenefits() {
        return handicapCompensationChildRequestData.getOtherBenefits();
    }
  
    public final void setOtherFolders(final List<org.libredemat.business.request.social.HccrOtherFolder> otherFolders) {
        handicapCompensationChildRequestData.setOtherFolders(otherFolders);
    }

    
    public final List<org.libredemat.business.request.social.HccrOtherFolder> getOtherFolders() {
        return handicapCompensationChildRequestData.getOtherFolders();
    }
  
    public final void setPaymentAgencyAddress(final org.libredemat.business.users.Address paymentAgencyAddress) {
        handicapCompensationChildRequestData.setPaymentAgencyAddress(paymentAgencyAddress);
    }

    
    public final org.libredemat.business.users.Address getPaymentAgencyAddress() {
        return handicapCompensationChildRequestData.getPaymentAgencyAddress();
    }
  
    public final void setPaymentAgencyBeneficiary(final org.libredemat.business.request.social.HccrPaymentAgencyBeneficiaryType paymentAgencyBeneficiary) {
        handicapCompensationChildRequestData.setPaymentAgencyBeneficiary(paymentAgencyBeneficiary);
    }

    
    public final org.libredemat.business.request.social.HccrPaymentAgencyBeneficiaryType getPaymentAgencyBeneficiary() {
    ...
    public final void setProfessionalStatusAddress(final org.libredemat.business.users.Address professionalStatusAddress) {
        handicapCompensationChildRequestData.setProfessionalStatusAddress(professionalStatusAddress);
    }

    
    public final org.libredemat.business.users.Address getProfessionalStatusAddress() {
    ...
    public final void setProfessionalStatusEnvironment(final org.libredemat.business.request.social.HccrProfessionalStatusEnvironmentType professionalStatusEnvironment) {
        handicapCompensationChildRequestData.setProfessionalStatusEnvironment(professionalStatusEnvironment);
    }

    
    public final org.libredemat.business.request.social.HccrProfessionalStatusEnvironmentType getProfessionalStatusEnvironment() {
    ...
    public final void setProfessionalStatusKind(final org.libredemat.business.request.social.HccrProfessionalStatusKindType professionalStatusKind) {
        handicapCompensationChildRequestData.setProfessionalStatusKind(professionalStatusKind);
    }

    
    public final org.libredemat.business.request.social.HccrProfessionalStatusKindType getProfessionalStatusKind() {
    ...
    public final void setProfessionals(final List<org.libredemat.business.request.social.HccrProfessional> professionals) {
        handicapCompensationChildRequestData.setProfessionals(professionals);
    }

    
    public final List<org.libredemat.business.request.social.HccrProfessional> getProfessionals() {
    ...
    public final void setReferentFamilyStatus(final org.libredemat.business.users.FamilyStatusType referentFamilyStatus) {
        handicapCompensationChildRequestData.setReferentFamilyStatus(referentFamilyStatus);
    }

    
    public final org.libredemat.business.users.FamilyStatusType getReferentFamilyStatus() {
    ...
    public final void setReferentTitle(final org.libredemat.business.users.TitleType referentTitle) {
        handicapCompensationChildRequestData.setReferentTitle(referentTitle);
    }

    
    public final org.libredemat.business.users.TitleType getReferentTitle() {
        return handicapCompensationChildRequestData.getReferentTitle();
    }
  
    public final void setSchoolingAttendedGrade(final org.libredemat.business.users.SectionType schoolingAttendedGrade) {
        handicapCompensationChildRequestData.setSchoolingAttendedGrade(schoolingAttendedGrade);
    }

    
    public final org.libredemat.business.users.SectionType getSchoolingAttendedGrade() {
    ...
    public final void setSchoolingHomeSchoolingAccompanistAddress(final org.libredemat.business.users.Address schoolingHomeSchoolingAccompanistAddress) {
    ...
    public final org.libredemat.business.users.Address getSchoolingHomeSchoolingAccompanistAddress() {
    ...
    public final void setSchoolingHomeSchoolingKind(final org.libredemat.business.request.social.HccrHomeSchoolingKindType schoolingHomeSchoolingKind) {
        handicapCompensationChildRequestData.setSchoolingHomeSchoolingKind(schoolingHomeSchoolingKind);
    }

    
    public final org.libredemat.business.request.social.HccrHomeSchoolingKindType getSchoolingHomeSchoolingKind() {
    ...
    public final void setSchoolingSchoolAddress(final org.libredemat.business.users.Address schoolingSchoolAddress) {
        handicapCompensationChildRequestData.setSchoolingSchoolAddress(schoolingSchoolAddress);
    }

    
    public final org.libredemat.business.users.Address getSchoolingSchoolAddress() {
    ...
    public final void setSchoolingSchoolingKind(final org.libredemat.business.request.social.HccrSchoolingKindType schoolingSchoolingKind) {
        handicapCompensationChildRequestData.setSchoolingSchoolingKind(schoolingSchoolingKind);
    }

    
    public final org.libredemat.business.request.social.HccrSchoolingKindType getSchoolingSchoolingKind() {
    ...
    public final void setSocialSecurityAgencyAddress(final org.libredemat.business.users.Address socialSecurityAgencyAddress) {
        handicapCompensationChildRequestData.setSocialSecurityAgencyAddress(socialSecurityAgencyAddress);
    }

    
    public final org.libredemat.business.users.Address getSocialSecurityAgencyAddress() {
    ...
    public final void setSocialSecurityMemberShipKind(final org.libredemat.business.request.social.HccrSocialSecurityMemberShipKindType socialSecurityMemberShipKind) {
        handicapCompensationChildRequestData.setSocialSecurityMemberShipKind(socialSecurityMemberShipKind);
    }

    
    public final org.libredemat.business.request.social.HccrSocialSecurityMemberShipKindType getSocialSecurityMemberShipKind() {
    ...
    public final void setSocialServiceAddress(final org.libredemat.business.users.Address socialServiceAddress) {
        handicapCompensationChildRequestData.setSocialServiceAddress(socialServiceAddress);
    }

    
    public final org.libredemat.business.users.Address getSocialServiceAddress() {
    ...
    public final void setStudiesHighSchoolAddress(final org.libredemat.business.users.Address studiesHighSchoolAddress) {
        handicapCompensationChildRequestData.setStudiesHighSchoolAddress(studiesHighSchoolAddress);
    }

    
    public final org.libredemat.business.users.Address getStudiesHighSchoolAddress() {
    ...
    public final void setSubjectParentalAuthorityHolder(final org.libredemat.business.request.social.HccrSubjectParentalAuthorityHolderType subjectParentalAuthorityHolder) {
        handicapCompensationChildRequestData.setSubjectParentalAuthorityHolder(subjectParentalAuthorityHolder);
    }

    
    public final org.libredemat.business.request.social.HccrSubjectParentalAuthorityHolderType getSubjectParentalAuthorityHolder() {
