...
public class DhrPreviousDwelling implements Serializable {
    ...
    public final DhrPreviousDwellingType modelToXml() {
        ...
        if (this.dhrPreviousDwellingStatus != null)
            dhrPreviousDwelling.setDhrPreviousDwellingStatus(org.libredemat.xml.request.social.DhrDwellingStatusType.Enum.forString(this.dhrPreviousDwellingStatus.getLegacyLabel()));
      
        if (this.dhrPreviousDwellingKind != null)
            dhrPreviousDwelling.setDhrPreviousDwellingKind(org.libredemat.xml.request.social.DhrDwellingKindType.Enum.forString(this.dhrPreviousDwellingKind.getLegacyLabel()));
    ...
    public static DhrPreviousDwelling xmlToModel(DhrPreviousDwellingType dhrPreviousDwellingDoc) {
        ...
        if (dhrPreviousDwellingDoc.getDhrPreviousDwellingStatus() != null)
            dhrPreviousDwelling.setDhrPreviousDwellingStatus(org.libredemat.business.request.social.DhrDwellingStatusType.forString(dhrPreviousDwellingDoc.getDhrPreviousDwellingStatus().toString()));
        else
            dhrPreviousDwelling.setDhrPreviousDwellingStatus(org.libredemat.business.request.social.DhrDwellingStatusType.getDefaultDhrDwellingStatusType());
      
        if (dhrPreviousDwellingDoc.getDhrPreviousDwellingKind() != null)
            dhrPreviousDwelling.setDhrPreviousDwellingKind(org.libredemat.business.request.social.DhrDwellingKindType.forString(dhrPreviousDwellingDoc.getDhrPreviousDwellingKind().toString()));
        else
            dhrPreviousDwelling.setDhrPreviousDwellingKind(org.libredemat.business.request.social.DhrDwellingKindType.getDefaultDhrDwellingKindType());
    ...
    public DhrPreviousDwelling clone() {
        ...
        if (dhrPreviousDwellingStatus != null)
            ...
            result.setDhrPreviousDwellingStatus(org.libredemat.business.request.social.DhrDwellingStatusType.getDefaultDhrDwellingStatusType());
        ...
        if (dhrPreviousDwellingKind != null)
            ...
            result.setDhrPreviousDwellingKind(org.libredemat.business.request.social.DhrDwellingKindType.getDefaultDhrDwellingKindType());
    ...
    private org.libredemat.business.request.social.DhrDwellingStatusType dhrPreviousDwellingStatus;

    public void setDhrPreviousDwellingStatus(final org.libredemat.business.request.social.DhrDwellingStatusType dhrPreviousDwellingStatus) {
    ...
    public org.libredemat.business.request.social.DhrDwellingStatusType getDhrPreviousDwellingStatus() {
    ...
    private org.libredemat.business.request.social.DhrDwellingKindType dhrPreviousDwellingKind;

    public void setDhrPreviousDwellingKind(final org.libredemat.business.request.social.DhrDwellingKindType dhrPreviousDwellingKind) {
    ...
    public org.libredemat.business.request.social.DhrDwellingKindType getDhrPreviousDwellingKind() {
    ...
    private org.libredemat.business.users.Address dhrPreviousDwellingAddress;

    public void setDhrPreviousDwellingAddress(final org.libredemat.business.users.Address dhrPreviousDwellingAddress) {
    ...
    public org.libredemat.business.users.Address getDhrPreviousDwellingAddress() {
