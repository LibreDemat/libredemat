...
public class HccrFamilyDependent implements Serializable {
    ...
    public final HccrFamilyDependentType modelToXml() {
        ...
        if (this.referentFamilyDependentActualSituation != null)
            hccrFamilyDependent.setReferentFamilyDependentActualSituation(org.libredemat.xml.request.social.HccrReferentFamilyDependentActualSituationType.Enum.forString(this.referentFamilyDependentActualSituation.getLegacyLabel()));
    ...
    public static HccrFamilyDependent xmlToModel(HccrFamilyDependentType hccrFamilyDependentDoc) {
        ...
        if (hccrFamilyDependentDoc.getReferentFamilyDependentActualSituation() != null)
            hccrFamilyDependent.setReferentFamilyDependentActualSituation(org.libredemat.business.request.social.HccrReferentFamilyDependentActualSituationType.forString(hccrFamilyDependentDoc.getReferentFamilyDependentActualSituation().toString()));
        else
            hccrFamilyDependent.setReferentFamilyDependentActualSituation(org.libredemat.business.request.social.HccrReferentFamilyDependentActualSituationType.getDefaultHccrReferentFamilyDependentActualSituationType());
    ...
    public HccrFamilyDependent clone() {
        ...
        if (referentFamilyDependentActualSituation != null)
            ...
            result.setReferentFamilyDependentActualSituation(org.libredemat.business.request.social.HccrReferentFamilyDependentActualSituationType.getDefaultHccrReferentFamilyDependentActualSituationType());
    ...
    private org.libredemat.business.request.social.HccrReferentFamilyDependentActualSituationType referentFamilyDependentActualSituation;

    public void setReferentFamilyDependentActualSituation(final org.libredemat.business.request.social.HccrReferentFamilyDependentActualSituationType referentFamilyDependentActualSituation) {
    ...
    public org.libredemat.business.request.social.HccrReferentFamilyDependentActualSituationType getReferentFamilyDependentActualSituation() {
