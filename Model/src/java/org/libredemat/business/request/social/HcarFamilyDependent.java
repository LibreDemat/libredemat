...
public class HcarFamilyDependent implements Serializable {
    ...
    public final HcarFamilyDependentType modelToXml() {
        ...
        if (this.familyDependentActualSituation != null)
            hcarFamilyDependent.setFamilyDependentActualSituation(org.libredemat.xml.request.social.HcarFamilyDependentActualSituationType.Enum.forString(this.familyDependentActualSituation.getLegacyLabel()));
    ...
    public static HcarFamilyDependent xmlToModel(HcarFamilyDependentType hcarFamilyDependentDoc) {
        ...
        if (hcarFamilyDependentDoc.getFamilyDependentActualSituation() != null)
            hcarFamilyDependent.setFamilyDependentActualSituation(org.libredemat.business.request.social.HcarFamilyDependentActualSituationType.forString(hcarFamilyDependentDoc.getFamilyDependentActualSituation().toString()));
        else
            hcarFamilyDependent.setFamilyDependentActualSituation(org.libredemat.business.request.social.HcarFamilyDependentActualSituationType.getDefaultHcarFamilyDependentActualSituationType());
    ...
    public HcarFamilyDependent clone() {
        ...
        if (familyDependentActualSituation != null)
            ...
            result.setFamilyDependentActualSituation(org.libredemat.business.request.social.HcarFamilyDependentActualSituationType.getDefaultHcarFamilyDependentActualSituationType());
    ...
    private org.libredemat.business.request.social.HcarFamilyDependentActualSituationType familyDependentActualSituation;

    public void setFamilyDependentActualSituation(final org.libredemat.business.request.social.HcarFamilyDependentActualSituationType familyDependentActualSituation) {
    ...
    public org.libredemat.business.request.social.HcarFamilyDependentActualSituationType getFamilyDependentActualSituation() {
