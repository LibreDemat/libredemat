...
public class RemoteSupportRequest extends Request implements Serializable {
    ...
    public final RemoteSupportRequestDocument modelToXml() {
        ...
        if (getContactKind() != null)
            remoteSupportRequest.setContactKind(org.libredemat.xml.request.social.RsrContactKindType.Enum.forString(getContactKind().getLegacyLabel()));
        ...
        if (getRequestInformationRequestKind() != null)
            rsrRequestInformationTypeRequestInformation.setRequestInformationRequestKind(org.libredemat.xml.request.social.RsrRequestInformationRequestKindType.Enum.forString(getRequestInformationRequestKind().getLegacyLabel()));
        ...
        if (getSpouseTitle() != null)
            rsrSpouseTypeSpouse.setSpouseTitle(org.libredemat.xml.common.TitleType.Enum.forString(getSpouseTitle().getLegacyLabel()));
        ...
        if (getSubjectResideWith() != null)
            rsrSubjectTypeRsrSubject.setSubjectResideWith(org.libredemat.xml.request.social.RsrSubjectResideWithType.Enum.forString(getSubjectResideWith().getLegacyLabel()));
      
        if (getSubjectTitle() != null)
            rsrSubjectTypeRsrSubject.setSubjectTitle(org.libredemat.xml.common.TitleType.Enum.forString(getSubjectTitle().getLegacyLabel()));
    ...
    public static RemoteSupportRequest xmlToModel(RemoteSupportRequestDocument remoteSupportRequestDoc) {
        ...
        if (remoteSupportRequestXml.getContactKind() != null)
            remoteSupportRequest.setContactKind(org.libredemat.business.request.social.RsrContactKindType.forString(remoteSupportRequestXml.getContactKind().toString()));
        else
            remoteSupportRequest.setContactKind(org.libredemat.business.request.social.RsrContactKindType.getDefaultRsrContactKindType());
        ...
        if (remoteSupportRequestXml.getRequestInformation().getRequestInformationRequestKind() != null)
            remoteSupportRequest.setRequestInformationRequestKind(org.libredemat.business.request.social.RsrRequestInformationRequestKindType.forString(remoteSupportRequestXml.getRequestInformation().getRequestInformationRequestKind().toString()));
        else
            remoteSupportRequest.setRequestInformationRequestKind(org.libredemat.business.request.social.RsrRequestInformationRequestKindType.getDefaultRsrRequestInformationRequestKindType());
        ...
        if (remoteSupportRequestXml.getSpouse().getSpouseTitle() != null)
            remoteSupportRequest.setSpouseTitle(org.libredemat.business.users.TitleType.forString(remoteSupportRequestXml.getSpouse().getSpouseTitle().toString()));
        else
            remoteSupportRequest.setSpouseTitle(org.libredemat.business.users.TitleType.getDefaultTitleType());
        ...
        if (remoteSupportRequestXml.getRsrSubject().getSubjectResideWith() != null)
            remoteSupportRequest.setSubjectResideWith(org.libredemat.business.request.social.RsrSubjectResideWithType.forString(remoteSupportRequestXml.getRsrSubject().getSubjectResideWith().toString()));
        else
            remoteSupportRequest.setSubjectResideWith(org.libredemat.business.request.social.RsrSubjectResideWithType.getDefaultRsrSubjectResideWithType());
      
        if (remoteSupportRequestXml.getRsrSubject().getSubjectTitle() != null)
            remoteSupportRequest.setSubjectTitle(org.libredemat.business.users.TitleType.forString(remoteSupportRequestXml.getRsrSubject().getSubjectTitle().toString()));
        else
            remoteSupportRequest.setSubjectTitle(org.libredemat.business.users.TitleType.getDefaultTitleType());
    ...
    public final void setContactKind(final org.libredemat.business.request.social.RsrContactKindType contactKind) {
        remoteSupportRequestData.setContactKind(contactKind);
    }

    
    public final org.libredemat.business.request.social.RsrContactKindType getContactKind() {
    ...
    public final void setRequestInformationRequestKind(final org.libredemat.business.request.social.RsrRequestInformationRequestKindType requestInformationRequestKind) {
        remoteSupportRequestData.setRequestInformationRequestKind(requestInformationRequestKind);
    }

    
    public final org.libredemat.business.request.social.RsrRequestInformationRequestKindType getRequestInformationRequestKind() {
    ...
    public final void setSpouseTitle(final org.libredemat.business.users.TitleType spouseTitle) {
        remoteSupportRequestData.setSpouseTitle(spouseTitle);
    }

    
    public final org.libredemat.business.users.TitleType getSpouseTitle() {
    ...
    public final void setSubjectResideWith(final org.libredemat.business.request.social.RsrSubjectResideWithType subjectResideWith) {
        remoteSupportRequestData.setSubjectResideWith(subjectResideWith);
    }

    
    public final org.libredemat.business.request.social.RsrSubjectResideWithType getSubjectResideWith() {
