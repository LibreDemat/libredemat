...
public class BirthDetailsRequestData implements Serializable {
    ...
    public BirthDetailsRequestData() {
        ...
        format = org.libredemat.business.request.civil.BirthCertificateFormatType.FULL_COPY;
    ...
    public BirthDetailsRequestData clone() {
        ...
        if (format != null)
            ...
            result.setFormat(org.libredemat.business.request.civil.BirthCertificateFormatType.getDefaultBirthCertificateFormatType());
        ...
        if (motive != null)
            ...
            result.setMotive(org.libredemat.business.request.civil.BirthCertificateMotiveType.getDefaultBirthCertificateMotiveType());
        ...
        if (requesterQuality != null)
            ...
            result.setRequesterQuality(org.libredemat.business.request.civil.BirthRequesterQualityType.getDefaultBirthRequesterQualityType());
    ...
    private org.libredemat.business.request.civil.BirthCertificateFormatType format;

    public void setFormat(final org.libredemat.business.request.civil.BirthCertificateFormatType format) {
        this.format = format;
    }
    ...
    public org.libredemat.business.request.civil.BirthCertificateFormatType getFormat() {
        return this.format;
    }
    ...
    private org.libredemat.business.request.civil.BirthCertificateMotiveType motive;

    public void setMotive(final org.libredemat.business.request.civil.BirthCertificateMotiveType motive) {
        this.motive = motive;
    }
    ...
    public org.libredemat.business.request.civil.BirthCertificateMotiveType getMotive() {
        return this.motive;
    }
    ...
    private org.libredemat.business.request.civil.BirthRequesterQualityType requesterQuality;

    public void setRequesterQuality(final org.libredemat.business.request.civil.BirthRequesterQualityType requesterQuality) {
    ...
    public org.libredemat.business.request.civil.BirthRequesterQualityType getRequesterQuality() {
