...
public class DeathDetailsRequestData implements Serializable {
    ...
    public DeathDetailsRequestData() {
        ...
        format = org.libredemat.business.request.civil.DeathCertificateFormatType.FULL_COPY;
    ...
    public DeathDetailsRequestData clone() {
        ...
        if (format != null)
            ...
            result.setFormat(org.libredemat.business.request.civil.DeathCertificateFormatType.getDefaultDeathCertificateFormatType());
        ...
        if (motive != null)
            ...
            result.setMotive(org.libredemat.business.request.civil.DeathCertificateMotiveType.getDefaultDeathCertificateMotiveType());
    ...
    private org.libredemat.business.request.civil.DeathCertificateFormatType format;

    public void setFormat(final org.libredemat.business.request.civil.DeathCertificateFormatType format) {
        this.format = format;
    }
    ...
    public org.libredemat.business.request.civil.DeathCertificateFormatType getFormat() {
        return this.format;
    }
  
    
    private org.libredemat.business.request.civil.DeathCertificateMotiveType motive;

    public void setMotive(final org.libredemat.business.request.civil.DeathCertificateMotiveType motive) {
        this.motive = motive;
    }
    ...
    public org.libredemat.business.request.civil.DeathCertificateMotiveType getMotive() {
        return this.motive;
    }
