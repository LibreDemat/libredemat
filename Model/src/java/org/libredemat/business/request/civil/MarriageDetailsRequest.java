...
public class MarriageDetailsRequest extends Request implements Serializable {
    ...
    public final MarriageDetailsRequestDocument modelToXml() {
        ...
        if (getFormat() != null)
            marriageDetailsRequest.setFormat(org.libredemat.xml.request.civil.MarriageCertificateFormatType.Enum.forString(getFormat().getLegacyLabel()));
        ...
        if (getMotive() != null)
            marriageDetailsRequest.setMotive(org.libredemat.xml.request.civil.MarriageCertificateMotiveType.Enum.forString(getMotive().getLegacyLabel()));
      
        if (getRelationship() != null)
            marriageDetailsRequest.setRelationship(org.libredemat.xml.request.civil.MarriageRelationshipType.Enum.forString(getRelationship().getLegacyLabel()));
      
        if (getRequesterQuality() != null)
            marriageDetailsRequest.setRequesterQuality(org.libredemat.xml.request.civil.MarriageRequesterQualityType.Enum.forString(getRequesterQuality().getLegacyLabel()));
    ...
    public static MarriageDetailsRequest xmlToModel(MarriageDetailsRequestDocument marriageDetailsRequestDoc) {
        ...
        if (marriageDetailsRequestXml.getFormat() != null)
            marriageDetailsRequest.setFormat(org.libredemat.business.request.civil.MarriageCertificateFormatType.forString(marriageDetailsRequestXml.getFormat().toString()));
        else
            marriageDetailsRequest.setFormat(org.libredemat.business.request.civil.MarriageCertificateFormatType.getDefaultMarriageCertificateFormatType());
        ...
        if (marriageDetailsRequestXml.getMotive() != null)
            marriageDetailsRequest.setMotive(org.libredemat.business.request.civil.MarriageCertificateMotiveType.forString(marriageDetailsRequestXml.getMotive().toString()));
        else
            marriageDetailsRequest.setMotive(org.libredemat.business.request.civil.MarriageCertificateMotiveType.getDefaultMarriageCertificateMotiveType());
      
        if (marriageDetailsRequestXml.getRelationship() != null)
            marriageDetailsRequest.setRelationship(org.libredemat.business.request.civil.MarriageRelationshipType.forString(marriageDetailsRequestXml.getRelationship().toString()));
        else
            marriageDetailsRequest.setRelationship(org.libredemat.business.request.civil.MarriageRelationshipType.getDefaultMarriageRelationshipType());
      
        if (marriageDetailsRequestXml.getRequesterQuality() != null)
            marriageDetailsRequest.setRequesterQuality(org.libredemat.business.request.civil.MarriageRequesterQualityType.forString(marriageDetailsRequestXml.getRequesterQuality().toString()));
        else
            marriageDetailsRequest.setRequesterQuality(org.libredemat.business.request.civil.MarriageRequesterQualityType.getDefaultMarriageRequesterQualityType());
    ...
    public final void setFormat(final org.libredemat.business.request.civil.MarriageCertificateFormatType format) {
        marriageDetailsRequestData.setFormat(format);
    }

    
    public final org.libredemat.business.request.civil.MarriageCertificateFormatType getFormat() {
    ...
    public final void setMotive(final org.libredemat.business.request.civil.MarriageCertificateMotiveType motive) {
        marriageDetailsRequestData.setMotive(motive);
    }

    
    public final org.libredemat.business.request.civil.MarriageCertificateMotiveType getMotive() {
        return marriageDetailsRequestData.getMotive();
    }
  
    public final void setRelationship(final org.libredemat.business.request.civil.MarriageRelationshipType relationship) {
        marriageDetailsRequestData.setRelationship(relationship);
    }

    
    public final org.libredemat.business.request.civil.MarriageRelationshipType getRelationship() {
        return marriageDetailsRequestData.getRelationship();
    }
  
    public final void setRequesterQuality(final org.libredemat.business.request.civil.MarriageRequesterQualityType requesterQuality) {
        marriageDetailsRequestData.setRequesterQuality(requesterQuality);
    }

    
    public final org.libredemat.business.request.civil.MarriageRequesterQualityType getRequesterQuality() {
