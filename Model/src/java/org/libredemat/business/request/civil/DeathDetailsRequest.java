...
public class DeathDetailsRequest extends Request implements Serializable {
    ...
    public final DeathDetailsRequestDocument modelToXml() {
        ...
        if (getFormat() != null)
            deathDetailsRequest.setFormat(org.libredemat.xml.request.civil.DeathCertificateFormatType.Enum.forString(getFormat().getLegacyLabel()));
      
        if (getMotive() != null)
            deathDetailsRequest.setMotive(org.libredemat.xml.request.civil.DeathCertificateMotiveType.Enum.forString(getMotive().getLegacyLabel()));
    ...
    public static DeathDetailsRequest xmlToModel(DeathDetailsRequestDocument deathDetailsRequestDoc) {
        ...
        if (deathDetailsRequestXml.getFormat() != null)
            deathDetailsRequest.setFormat(org.libredemat.business.request.civil.DeathCertificateFormatType.forString(deathDetailsRequestXml.getFormat().toString()));
        else
            deathDetailsRequest.setFormat(org.libredemat.business.request.civil.DeathCertificateFormatType.getDefaultDeathCertificateFormatType());
      
        if (deathDetailsRequestXml.getMotive() != null)
            deathDetailsRequest.setMotive(org.libredemat.business.request.civil.DeathCertificateMotiveType.forString(deathDetailsRequestXml.getMotive().toString()));
        else
            deathDetailsRequest.setMotive(org.libredemat.business.request.civil.DeathCertificateMotiveType.getDefaultDeathCertificateMotiveType());
    ...
    public final void setFormat(final org.libredemat.business.request.civil.DeathCertificateFormatType format) {
        deathDetailsRequestData.setFormat(format);
    }

    
    public final org.libredemat.business.request.civil.DeathCertificateFormatType getFormat() {
        return deathDetailsRequestData.getFormat();
    }
  
    public final void setMotive(final org.libredemat.business.request.civil.DeathCertificateMotiveType motive) {
        deathDetailsRequestData.setMotive(motive);
    }

    
    public final org.libredemat.business.request.civil.DeathCertificateMotiveType getMotive() {
