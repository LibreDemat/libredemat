...
public class CompostableWasteCollectionRequestData implements Serializable {
    ...
    public CompostableWasteCollectionRequestData clone() {
        ...
        List<org.libredemat.business.request.LocalReferentialData> compostableWasteTypeList = new ArrayList<org.libredemat.business.request.LocalReferentialData>();
    ...
    private List<org.libredemat.business.request.LocalReferentialData> compostableWasteType;

    public void setCompostableWasteType(final List<org.libredemat.business.request.LocalReferentialData> compostableWasteType) {
    ...
    public List<org.libredemat.business.request.LocalReferentialData> getCompostableWasteType() {
