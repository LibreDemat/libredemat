...
public class SchoolTransportRegistrationRequest extends Request implements Serializable {
    ...
    public final SchoolTransportRegistrationRequestDocument modelToXml() {
        ...
        if (getAutorisation() != null)
            schoolTransportRegistrationRequest.setAutorisation(org.libredemat.xml.request.school.AutorisationType.Enum.forString(getAutorisation().getLegacyLabel()));
        ...
        if (getTiersAutorises() != null) {
            org.libredemat.xml.request.school.TiersInformationsType[] tiersAutorisesTypeTab = new org.libredemat.xml.request.school.TiersInformationsType[getTiersAutorises().size()];
    ...
    public static SchoolTransportRegistrationRequest xmlToModel(SchoolTransportRegistrationRequestDocument schoolTransportRegistrationRequestDoc) {
        ...
        if (schoolTransportRegistrationRequestXml.getAutorisation() != null)
            schoolTransportRegistrationRequest.setAutorisation(org.libredemat.business.request.school.AutorisationType.forString(schoolTransportRegistrationRequestXml.getAutorisation().toString()));
        else
            schoolTransportRegistrationRequest.setAutorisation(org.libredemat.business.request.school.AutorisationType.getDefaultAutorisationType());
        ...
        List<org.libredemat.business.request.school.TiersInformations> tiersAutorisesList = new ArrayList<org.libredemat.business.request.school.TiersInformations>(schoolTransportRegistrationRequestXml.sizeOfTiersAutorisesArray());
        for (TiersInformationsType object : schoolTransportRegistrationRequestXml.getTiersAutorisesArray()) {
            tiersAutorisesList.add(org.libredemat.business.request.school.TiersInformations.xmlToModel(object));
        }
    ...
    public final void setAutorisation(final org.libredemat.business.request.school.AutorisationType autorisation) {
        schoolTransportRegistrationRequestData.setAutorisation(autorisation);
    }

    
    public final org.libredemat.business.request.school.AutorisationType getAutorisation() {
    ...
    public final void setTiersAutorises(final List<org.libredemat.business.request.school.TiersInformations> tiersAutorises) {
        schoolTransportRegistrationRequestData.setTiersAutorises(tiersAutorises);
    }

    
    public final List<org.libredemat.business.request.school.TiersInformations> getTiersAutorises() {
