...
public class DayCareCenterRegistrationRequest extends Request implements Serializable {
    ...
    public final DayCareCenterRegistrationRequestDocument modelToXml() {
        ...
        if (getChoixHorairesAccueil() != null)
            dayCareCenterRegistrationRequest.setChoixHorairesAccueil(org.libredemat.xml.request.school.ChoixHorairesAccueilType.Enum.forString(getChoixHorairesAccueil().getLegacyLabel()));
        ...
        if (getChoixTypeDatePlacementAccueilRegulier() != null)
            dccrrDatesPlacementTypeDatePlacementAccueilRegulier.setChoixTypeDatePlacementAccueilRegulier(org.libredemat.xml.request.school.ChoixDatePlacement.Enum.forString(getChoixTypeDatePlacementAccueilRegulier().getLegacyLabel()));
      
        if (getChoixTypeRendezVous() != null)
            dayCareCenterRegistrationRequest.setChoixTypeRendezVous(org.libredemat.xml.request.school.RendezVousType.Enum.forString(getChoixTypeRendezVous().getLegacyLabel()));
        ...
        if (getModeAccueilChoixDeux() != null)
            dayCareCenterRegistrationRequest.setModeAccueilChoixDeux(org.libredemat.xml.request.school.ModeAccueilType.Enum.forString(getModeAccueilChoixDeux().getLegacyLabel()));
      
        if (getModeAccueilChoixUn() != null)
            dayCareCenterRegistrationRequest.setModeAccueilChoixUn(org.libredemat.xml.request.school.ModeAccueilType.Enum.forString(getModeAccueilChoixUn().getLegacyLabel()));
      
        if (getPlageHoraireContact() != null)
            dayCareCenterRegistrationRequest.setPlageHoraireContact(org.libredemat.xml.request.school.PlageHoraireContactType.Enum.forString(getPlageHoraireContact().getLegacyLabel()));
        ...
        if (getSituationActuelleMere() != null)
            dccrrMereTypeInformationMere.setSituationActuelleMere(org.libredemat.xml.request.school.ChoixSituationActuelle.Enum.forString(getSituationActuelleMere().getLegacyLabel()));
      
        if (getSituationActuellePere() != null)
            dccrrPereTypeInformationPere.setSituationActuellePere(org.libredemat.xml.request.school.ChoixSituationActuelle.Enum.forString(getSituationActuellePere().getLegacyLabel()));
    ...
    public static DayCareCenterRegistrationRequest xmlToModel(DayCareCenterRegistrationRequestDocument dayCareCenterRegistrationRequestDoc) {
        ...
        if (dayCareCenterRegistrationRequestXml.getChoixHorairesAccueil() != null)
            dayCareCenterRegistrationRequest.setChoixHorairesAccueil(org.libredemat.business.request.school.ChoixHorairesAccueilType.forString(dayCareCenterRegistrationRequestXml.getChoixHorairesAccueil().toString()));
        else
            dayCareCenterRegistrationRequest.setChoixHorairesAccueil(org.libredemat.business.request.school.ChoixHorairesAccueilType.getDefaultChoixHorairesAccueilType());
      
        if (dayCareCenterRegistrationRequestXml.getDatePlacementAccueilRegulier().getChoixTypeDatePlacementAccueilRegulier() != null)
            dayCareCenterRegistrationRequest.setChoixTypeDatePlacementAccueilRegulier(org.libredemat.business.request.school.ChoixDatePlacement.forString(dayCareCenterRegistrationRequestXml.getDatePlacementAccueilRegulier().getChoixTypeDatePlacementAccueilRegulier().toString()));
        else
            dayCareCenterRegistrationRequest.setChoixTypeDatePlacementAccueilRegulier(org.libredemat.business.request.school.ChoixDatePlacement.getDefaultChoixDatePlacement());
      
        if (dayCareCenterRegistrationRequestXml.getChoixTypeRendezVous() != null)
            dayCareCenterRegistrationRequest.setChoixTypeRendezVous(org.libredemat.business.request.school.RendezVousType.forString(dayCareCenterRegistrationRequestXml.getChoixTypeRendezVous().toString()));
        else
            dayCareCenterRegistrationRequest.setChoixTypeRendezVous(org.libredemat.business.request.school.RendezVousType.getDefaultRendezVousType());
        ...
        if (dayCareCenterRegistrationRequestXml.getModeAccueilChoixDeux() != null)
            dayCareCenterRegistrationRequest.setModeAccueilChoixDeux(org.libredemat.business.request.school.ModeAccueilType.forString(dayCareCenterRegistrationRequestXml.getModeAccueilChoixDeux().toString()));
        else
            dayCareCenterRegistrationRequest.setModeAccueilChoixDeux(org.libredemat.business.request.school.ModeAccueilType.getDefaultModeAccueilType());
      
        if (dayCareCenterRegistrationRequestXml.getModeAccueilChoixUn() != null)
            dayCareCenterRegistrationRequest.setModeAccueilChoixUn(org.libredemat.business.request.school.ModeAccueilType.forString(dayCareCenterRegistrationRequestXml.getModeAccueilChoixUn().toString()));
        else
            dayCareCenterRegistrationRequest.setModeAccueilChoixUn(org.libredemat.business.request.school.ModeAccueilType.getDefaultModeAccueilType());
      
        if (dayCareCenterRegistrationRequestXml.getPlageHoraireContact() != null)
            dayCareCenterRegistrationRequest.setPlageHoraireContact(org.libredemat.business.request.school.PlageHoraireContactType.forString(dayCareCenterRegistrationRequestXml.getPlageHoraireContact().toString()));
        else
            dayCareCenterRegistrationRequest.setPlageHoraireContact(org.libredemat.business.request.school.PlageHoraireContactType.getDefaultPlageHoraireContactType());
        ...
        if (dayCareCenterRegistrationRequestXml.getInformationMere().getSituationActuelleMere() != null)
            dayCareCenterRegistrationRequest.setSituationActuelleMere(org.libredemat.business.request.school.ChoixSituationActuelle.forString(dayCareCenterRegistrationRequestXml.getInformationMere().getSituationActuelleMere().toString()));
        else
            dayCareCenterRegistrationRequest.setSituationActuelleMere(org.libredemat.business.request.school.ChoixSituationActuelle.getDefaultChoixSituationActuelle());
      
        if (dayCareCenterRegistrationRequestXml.getInformationPere().getSituationActuellePere() != null)
            dayCareCenterRegistrationRequest.setSituationActuellePere(org.libredemat.business.request.school.ChoixSituationActuelle.forString(dayCareCenterRegistrationRequestXml.getInformationPere().getSituationActuellePere().toString()));
        else
            dayCareCenterRegistrationRequest.setSituationActuellePere(org.libredemat.business.request.school.ChoixSituationActuelle.getDefaultChoixSituationActuelle());
    ...
    public final void setChoixHorairesAccueil(final org.libredemat.business.request.school.ChoixHorairesAccueilType choixHorairesAccueil) {
        dayCareCenterRegistrationRequestData.setChoixHorairesAccueil(choixHorairesAccueil);
    }

    
    public final org.libredemat.business.request.school.ChoixHorairesAccueilType getChoixHorairesAccueil() {
        return dayCareCenterRegistrationRequestData.getChoixHorairesAccueil();
    }
  
    public final void setChoixTypeDatePlacementAccueilRegulier(final org.libredemat.business.request.school.ChoixDatePlacement choixTypeDatePlacementAccueilRegulier) {
        dayCareCenterRegistrationRequestData.setChoixTypeDatePlacementAccueilRegulier(choixTypeDatePlacementAccueilRegulier);
    }

    
    public final org.libredemat.business.request.school.ChoixDatePlacement getChoixTypeDatePlacementAccueilRegulier() {
        return dayCareCenterRegistrationRequestData.getChoixTypeDatePlacementAccueilRegulier();
    }
  
    public final void setChoixTypeRendezVous(final org.libredemat.business.request.school.RendezVousType choixTypeRendezVous) {
        dayCareCenterRegistrationRequestData.setChoixTypeRendezVous(choixTypeRendezVous);
    }

    
    public final org.libredemat.business.request.school.RendezVousType getChoixTypeRendezVous() {
    ...
    public final void setModeAccueilChoixDeux(final org.libredemat.business.request.school.ModeAccueilType modeAccueilChoixDeux) {
        dayCareCenterRegistrationRequestData.setModeAccueilChoixDeux(modeAccueilChoixDeux);
    }

    
    public final org.libredemat.business.request.school.ModeAccueilType getModeAccueilChoixDeux() {
        return dayCareCenterRegistrationRequestData.getModeAccueilChoixDeux();
    }
  
    public final void setModeAccueilChoixUn(final org.libredemat.business.request.school.ModeAccueilType modeAccueilChoixUn) {
        dayCareCenterRegistrationRequestData.setModeAccueilChoixUn(modeAccueilChoixUn);
    }

    
    public final org.libredemat.business.request.school.ModeAccueilType getModeAccueilChoixUn() {
        return dayCareCenterRegistrationRequestData.getModeAccueilChoixUn();
    }
  
    public final void setPlageHoraireContact(final org.libredemat.business.request.school.PlageHoraireContactType plageHoraireContact) {
        dayCareCenterRegistrationRequestData.setPlageHoraireContact(plageHoraireContact);
    }

    
    public final org.libredemat.business.request.school.PlageHoraireContactType getPlageHoraireContact() {
    ...
    public final void setSituationActuelleMere(final org.libredemat.business.request.school.ChoixSituationActuelle situationActuelleMere) {
        dayCareCenterRegistrationRequestData.setSituationActuelleMere(situationActuelleMere);
    }

    
    public final org.libredemat.business.request.school.ChoixSituationActuelle getSituationActuelleMere() {
        return dayCareCenterRegistrationRequestData.getSituationActuelleMere();
    }
  
    public final void setSituationActuellePere(final org.libredemat.business.request.school.ChoixSituationActuelle situationActuellePere) {
        dayCareCenterRegistrationRequestData.setSituationActuellePere(situationActuellePere);
    }

    
    public final org.libredemat.business.request.school.ChoixSituationActuelle getSituationActuellePere() {
