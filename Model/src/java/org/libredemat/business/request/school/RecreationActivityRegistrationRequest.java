...
public class RecreationActivityRegistrationRequest extends Request implements Serializable {
    ...
    public final RecreationActivityRegistrationRequestDocument modelToXml() {
        ...
        if (getAuthorizedIndividuals() != null) {
            org.libredemat.xml.request.school.RecreationAuthorizedIndividualType[] authorizedIndividualsTypeTab = new org.libredemat.xml.request.school.RecreationAuthorizedIndividualType[getAuthorizedIndividuals().size()];
        ...
        if (getContactIndividuals() != null) {
            org.libredemat.xml.request.school.RecreationContactIndividualType[] contactIndividualsTypeTab = new org.libredemat.xml.request.school.RecreationContactIndividualType[getContactIndividuals().size()];
        ...
        if (getRecreationActivity() != null) {
            org.libredemat.xml.common.LocalReferentialDataType[] recreationActivityTypeTab = new org.libredemat.xml.common.LocalReferentialDataType[getRecreationActivity().size()];
    ...
    public static RecreationActivityRegistrationRequest xmlToModel(RecreationActivityRegistrationRequestDocument recreationActivityRegistrationRequestDoc) {
        ...
        List<org.libredemat.business.request.school.RecreationAuthorizedIndividual> authorizedIndividualsList = new ArrayList<org.libredemat.business.request.school.RecreationAuthorizedIndividual>(recreationActivityRegistrationRequestXml.sizeOfAuthorizedIndividualsArray());
        for (RecreationAuthorizedIndividualType object : recreationActivityRegistrationRequestXml.getAuthorizedIndividualsArray()) {
            authorizedIndividualsList.add(org.libredemat.business.request.school.RecreationAuthorizedIndividual.xmlToModel(object));
        }
        ...
        List<org.libredemat.business.request.school.RecreationContactIndividual> contactIndividualsList = new ArrayList<org.libredemat.business.request.school.RecreationContactIndividual>(recreationActivityRegistrationRequestXml.sizeOfContactIndividualsArray());
        for (RecreationContactIndividualType object : recreationActivityRegistrationRequestXml.getContactIndividualsArray()) {
            contactIndividualsList.add(org.libredemat.business.request.school.RecreationContactIndividual.xmlToModel(object));
        }
        ...
        List<org.libredemat.business.request.LocalReferentialData> recreationActivityList = new ArrayList<org.libredemat.business.request.LocalReferentialData>(recreationActivityRegistrationRequestXml.sizeOfRecreationActivityArray());
        for (LocalReferentialDataType object : recreationActivityRegistrationRequestXml.getRecreationActivityArray()) {
            recreationActivityList.add(org.libredemat.business.request.LocalReferentialData.xmlToModel(object));
        }
    ...
    public final void setAuthorizedIndividuals(final List<org.libredemat.business.request.school.RecreationAuthorizedIndividual> authorizedIndividuals) {
        recreationActivityRegistrationRequestData.setAuthorizedIndividuals(authorizedIndividuals);
    }

    
    public final List<org.libredemat.business.request.school.RecreationAuthorizedIndividual> getAuthorizedIndividuals() {
    ...
    public final void setContactIndividuals(final List<org.libredemat.business.request.school.RecreationContactIndividual> contactIndividuals) {
        recreationActivityRegistrationRequestData.setContactIndividuals(contactIndividuals);
    }

    
    public final List<org.libredemat.business.request.school.RecreationContactIndividual> getContactIndividuals() {
    ...
    public final void setRecreationActivity(final List<org.libredemat.business.request.LocalReferentialData> recreationActivity) {
        recreationActivityRegistrationRequestData.setRecreationActivity(recreationActivity);
    }

    
    public final List<org.libredemat.business.request.LocalReferentialData> getRecreationActivity() {
        return recreationActivityRegistrationRequestData.getRecreationActivity();
    }
  
    public final void setRecreationCenter(final org.libredemat.business.authority.RecreationCenter recreationCenter) {
        recreationActivityRegistrationRequestData.setRecreationCenter(recreationCenter);
    }

    
    public final org.libredemat.business.authority.RecreationCenter getRecreationCenter() {
