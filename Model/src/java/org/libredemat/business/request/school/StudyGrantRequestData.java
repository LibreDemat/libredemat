...
public class StudyGrantRequestData implements Serializable {
    ...
    public StudyGrantRequestData() {
        ...
        distance = org.libredemat.business.request.school.DistanceType.UNDETERMINED;
    ...
    public StudyGrantRequestData clone() {
        ...
        if (abroadInternshipSchoolCountry != null)
            ...
            result.setAbroadInternshipSchoolCountry(org.libredemat.business.users.CountryType.getDefaultCountryType());
        ...
        if (accountHolderTitle != null)
            ...
            result.setAccountHolderTitle(org.libredemat.business.users.TitleType.getDefaultTitleType());
        ...
        if (alevels != null)
            ...
            result.setAlevels(org.libredemat.business.request.school.ALevelsType.getDefaultALevelsType());
        ...
        List<org.libredemat.business.request.LocalReferentialData> currentSchoolNameList = new ArrayList<org.libredemat.business.request.LocalReferentialData>();
        ...
        if (currentStudiesDiploma != null)
            ...
            result.setCurrentStudiesDiploma(org.libredemat.business.request.school.CurrentStudiesType.getDefaultCurrentStudiesType());
        ...
        if (currentStudiesLevel != null)
            ...
            result.setCurrentStudiesLevel(org.libredemat.business.request.school.CurrentStudiesLevelType.getDefaultCurrentStudiesLevelType());
        ...
        if (distance != null)
            ...
            result.setDistance(org.libredemat.business.request.school.DistanceType.getDefaultDistanceType());
        ...
        List<org.libredemat.business.request.LocalReferentialData> taxHouseholdCityList = new ArrayList<org.libredemat.business.request.LocalReferentialData>();
    ...
    private org.libredemat.business.users.CountryType abroadInternshipSchoolCountry;

    public void setAbroadInternshipSchoolCountry(final org.libredemat.business.users.CountryType abroadInternshipSchoolCountry) {
    ...
    public org.libredemat.business.users.CountryType getAbroadInternshipSchoolCountry() {
    ...
    private org.libredemat.business.users.TitleType accountHolderTitle;

    public void setAccountHolderTitle(final org.libredemat.business.users.TitleType accountHolderTitle) {
    ...
    public org.libredemat.business.users.TitleType getAccountHolderTitle() {
    ...
    private org.libredemat.business.request.school.ALevelsType alevels;

    public void setAlevels(final org.libredemat.business.request.school.ALevelsType alevels) {
    ...
    public org.libredemat.business.request.school.ALevelsType getAlevels() {
        return this.alevels;
    }
    ...
    private org.libredemat.business.users.BankAccount bankAccount;

    public void setBankAccount(final org.libredemat.business.users.BankAccount bankAccount) {
    ...
    public org.libredemat.business.users.BankAccount getBankAccount() {
    ...
    private org.libredemat.business.users.Address currentSchoolAddress;

    public void setCurrentSchoolAddress(final org.libredemat.business.users.Address currentSchoolAddress) {
    ...
    public org.libredemat.business.users.Address getCurrentSchoolAddress() {
    ...
    private List<org.libredemat.business.request.LocalReferentialData> currentSchoolName;

    public void setCurrentSchoolName(final List<org.libredemat.business.request.LocalReferentialData> currentSchoolName) {
    ...
    public List<org.libredemat.business.request.LocalReferentialData> getCurrentSchoolName() {
    ...
    private org.libredemat.business.request.school.CurrentStudiesType currentStudiesDiploma;

    public void setCurrentStudiesDiploma(final org.libredemat.business.request.school.CurrentStudiesType currentStudiesDiploma) {
    ...
    public org.libredemat.business.request.school.CurrentStudiesType getCurrentStudiesDiploma() {
    ...
    private org.libredemat.business.request.school.CurrentStudiesLevelType currentStudiesLevel;

    public void setCurrentStudiesLevel(final org.libredemat.business.request.school.CurrentStudiesLevelType currentStudiesLevel) {
    ...
    public org.libredemat.business.request.school.CurrentStudiesLevelType getCurrentStudiesLevel() {
    ...
    private org.libredemat.business.request.school.DistanceType distance;

    public void setDistance(final org.libredemat.business.request.school.DistanceType distance) {
    ...
    public org.libredemat.business.request.school.DistanceType getDistance() {
    ...
    private List<org.libredemat.business.request.LocalReferentialData> taxHouseholdCity;

    public void setTaxHouseholdCity(final List<org.libredemat.business.request.LocalReferentialData> taxHouseholdCity) {
    ...
    public List<org.libredemat.business.request.LocalReferentialData> getTaxHouseholdCity() {
