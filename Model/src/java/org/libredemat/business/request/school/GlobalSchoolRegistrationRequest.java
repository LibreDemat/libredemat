...
public class GlobalSchoolRegistrationRequest extends Request implements Serializable {
    ...
    public final GlobalSchoolRegistrationRequestDocument modelToXml() {
        ...
        if (getMotifsDerogationEcole() != null) {
            org.libredemat.xml.common.LocalReferentialDataType[] motifsDerogationEcoleTypeTab = new org.libredemat.xml.common.LocalReferentialDataType[getMotifsDerogationEcole().size()];
    ...
    public static GlobalSchoolRegistrationRequest xmlToModel(GlobalSchoolRegistrationRequestDocument globalSchoolRegistrationRequestDoc) {
        ...
        List<org.libredemat.business.request.LocalReferentialData> motifsDerogationEcoleList = new ArrayList<org.libredemat.business.request.LocalReferentialData>(globalSchoolRegistrationRequestXml.sizeOfMotifsDerogationEcoleArray());
        for (LocalReferentialDataType object : globalSchoolRegistrationRequestXml.getMotifsDerogationEcoleArray()) {
            motifsDerogationEcoleList.add(org.libredemat.business.request.LocalReferentialData.xmlToModel(object));
        }
    ...
    public final void setMotifsDerogationEcole(final List<org.libredemat.business.request.LocalReferentialData> motifsDerogationEcole) {
        globalSchoolRegistrationRequestData.setMotifsDerogationEcole(motifsDerogationEcole);
    }

    
    public final List<org.libredemat.business.request.LocalReferentialData> getMotifsDerogationEcole() {
