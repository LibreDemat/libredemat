...
public class GlobalSchoolRegistrationRequestData implements Serializable {
    ...
    public GlobalSchoolRegistrationRequestData clone() {
        ...
        List<org.libredemat.business.request.LocalReferentialData> motifsDerogationEcoleList = new ArrayList<org.libredemat.business.request.LocalReferentialData>();
    ...
    private List<org.libredemat.business.request.LocalReferentialData> motifsDerogationEcole;

    public void setMotifsDerogationEcole(final List<org.libredemat.business.request.LocalReferentialData> motifsDerogationEcole) {
    ...
    public List<org.libredemat.business.request.LocalReferentialData> getMotifsDerogationEcole() {
