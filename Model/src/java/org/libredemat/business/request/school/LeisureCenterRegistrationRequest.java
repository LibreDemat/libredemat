...
public class LeisureCenterRegistrationRequest extends Request implements Serializable {
    ...
    public final LeisureCenterRegistrationRequestDocument modelToXml() {
        ...
        if (getMotifsDerogationCentreLoisirs() != null) {
            org.libredemat.xml.common.LocalReferentialDataType[] motifsDerogationCentreLoisirsTypeTab = new org.libredemat.xml.common.LocalReferentialDataType[getMotifsDerogationCentreLoisirs().size()];
    ...
    public static LeisureCenterRegistrationRequest xmlToModel(LeisureCenterRegistrationRequestDocument leisureCenterRegistrationRequestDoc) {
        ...
        List<org.libredemat.business.request.LocalReferentialData> motifsDerogationCentreLoisirsList = new ArrayList<org.libredemat.business.request.LocalReferentialData>(leisureCenterRegistrationRequestXml.sizeOfMotifsDerogationCentreLoisirsArray());
        for (LocalReferentialDataType object : leisureCenterRegistrationRequestXml.getMotifsDerogationCentreLoisirsArray()) {
            motifsDerogationCentreLoisirsList.add(org.libredemat.business.request.LocalReferentialData.xmlToModel(object));
        }
    ...
    public final void setMotifsDerogationCentreLoisirs(final List<org.libredemat.business.request.LocalReferentialData> motifsDerogationCentreLoisirs) {
        leisureCenterRegistrationRequestData.setMotifsDerogationCentreLoisirs(motifsDerogationCentreLoisirs);
    }

    
    public final List<org.libredemat.business.request.LocalReferentialData> getMotifsDerogationCentreLoisirs() {
