...
package org.libredemat.business.request.reservation;
...
import org.libredemat.xml.request.reservation.*;
...
public class TicketBookingRequest extends Request implements Serializable {
    ...
    public final TicketBookingRequestDocument modelToXml() {
        ...
        if (getTbrTicket() != null) {
            org.libredemat.xml.request.reservation.TbrTicketType[] tbrTicketTypeTab = new org.libredemat.xml.request.reservation.TbrTicketType[getTbrTicket().size()];
    ...
    public static TicketBookingRequest xmlToModel(TicketBookingRequestDocument ticketBookingRequestDoc) {
        ...
        List<org.libredemat.business.request.reservation.TbrTicket> tbrTicketList = new ArrayList<org.libredemat.business.request.reservation.TbrTicket>(ticketBookingRequestXml.sizeOfTbrTicketArray());
        for (TbrTicketType object : ticketBookingRequestXml.getTbrTicketArray()) {
            tbrTicketList.add(org.libredemat.business.request.reservation.TbrTicket.xmlToModel(object));
        }
    ...
    public final void setTbrTicket(final List<org.libredemat.business.request.reservation.TbrTicket> tbrTicket) {
        ticketBookingRequestData.setTbrTicket(tbrTicket);
    }

    
    public final List<org.libredemat.business.request.reservation.TbrTicket> getTbrTicket() {
