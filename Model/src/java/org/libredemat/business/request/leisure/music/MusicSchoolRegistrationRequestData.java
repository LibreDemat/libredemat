...
public class MusicSchoolRegistrationRequestData implements Serializable {
    ...
    public MusicSchoolRegistrationRequestData clone() {
        ...
        List<org.libredemat.business.request.LocalReferentialData> activityList = new ArrayList<org.libredemat.business.request.LocalReferentialData>();
    ...
    private List<org.libredemat.business.request.LocalReferentialData> activity;

    public void setActivity(final List<org.libredemat.business.request.LocalReferentialData> activity) {
    ...
    public List<org.libredemat.business.request.LocalReferentialData> getActivity() {
