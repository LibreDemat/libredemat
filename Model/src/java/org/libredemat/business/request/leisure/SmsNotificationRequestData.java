...
public class SmsNotificationRequestData implements Serializable {
    ...
    public SmsNotificationRequestData clone() {
        ...
        List<org.libredemat.business.request.LocalReferentialData> interestsList = new ArrayList<org.libredemat.business.request.LocalReferentialData>();
    ...
    private List<org.libredemat.business.request.LocalReferentialData> interests;

    public void setInterests(final List<org.libredemat.business.request.LocalReferentialData> interests) {
    ...
    public List<org.libredemat.business.request.LocalReferentialData> getInterests() {
