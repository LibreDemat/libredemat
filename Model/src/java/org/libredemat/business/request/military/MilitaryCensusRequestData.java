...
public class MilitaryCensusRequestData implements Serializable {
    ...
    public MilitaryCensusRequestData() {
        ...
        childBirthCountry = org.libredemat.business.users.CountryType.FR;
      
        childCountry = org.libredemat.business.users.FullNationalityType.FR;
      
        childResidenceCountry = org.libredemat.business.users.CountryType.FR;
      
        childStatus = org.libredemat.business.users.FamilyStatusType.OTHER;
      
        highlyInfirm = Boolean.valueOf(false);
      
        japdExemption = Boolean.valueOf(false);
      
        motherNationality = org.libredemat.business.users.FullNationalityType.FR;
    ...
    public MilitaryCensusRequestData clone() {
        ...
        if (childBirthCountry != null)
            ...
            result.setChildBirthCountry(org.libredemat.business.users.CountryType.getDefaultCountryType());
        ...
        if (childCountry != null)
            ...
            result.setChildCountry(org.libredemat.business.users.FullNationalityType.getDefaultFullNationalityType());
        ...
        if (childDiploma != null)
            ...
            result.setChildDiploma(org.libredemat.business.request.military.ChildDiplomaType.getDefaultChildDiplomaType());
        ...
        if (childOtherCountry != null)
            ...
            result.setChildOtherCountry(org.libredemat.business.users.FullNationalityType.getDefaultFullNationalityType());
        ...
        if (childResidenceCountry != null)
            ...
            result.setChildResidenceCountry(org.libredemat.business.users.CountryType.getDefaultCountryType());
        ...
        if (childSituation != null)
            ...
            result.setChildSituation(org.libredemat.business.request.military.ChildSituationType.getDefaultChildSituationType());
        ...
        if (childStatus != null)
            ...
            result.setChildStatus(org.libredemat.business.users.FamilyStatusType.getDefaultFamilyStatusType());
        ...
        if (childTitle != null)
            ...
            result.setChildTitle(org.libredemat.business.users.TitleType.getDefaultTitleType());
        ...
        if (fatherBirthCountry != null)
            ...
            result.setFatherBirthCountry(org.libredemat.business.users.CountryType.getDefaultCountryType());
        ...
        if (fatherBirthDepartment != null)
            ...
            result.setFatherBirthDepartment(org.libredemat.business.users.InseeDepartementCodeType.getDefaultInseeDepartementCodeType());
        ...
        if (fatherNationality != null)
            ...
            result.setFatherNationality(org.libredemat.business.users.FullNationalityType.getDefaultFullNationalityType());
        ...
        if (motherBirthCountry != null)
            ...
            result.setMotherBirthCountry(org.libredemat.business.users.CountryType.getDefaultCountryType());
        ...
        if (motherBirthDepartment != null)
            ...
            result.setMotherBirthDepartment(org.libredemat.business.users.InseeDepartementCodeType.getDefaultInseeDepartementCodeType());
        ...
        if (motherNationality != null)
            ...
            result.setMotherNationality(org.libredemat.business.users.FullNationalityType.getDefaultFullNationalityType());
        ...
        if (prefectPupilDepartment != null)
            ...
            result.setPrefectPupilDepartment(org.libredemat.business.users.InseeDepartementCodeType.getDefaultInseeDepartementCodeType());
    ...
    private org.libredemat.business.users.CountryType childBirthCountry;

    public void setChildBirthCountry(final org.libredemat.business.users.CountryType childBirthCountry) {
    ...
    public org.libredemat.business.users.CountryType getChildBirthCountry() {
    ...
    private org.libredemat.business.users.FullNationalityType childCountry;

    public void setChildCountry(final org.libredemat.business.users.FullNationalityType childCountry) {
    ...
    public org.libredemat.business.users.FullNationalityType getChildCountry() {
    ...
    private org.libredemat.business.request.military.ChildDiplomaType childDiploma;

    public void setChildDiploma(final org.libredemat.business.request.military.ChildDiplomaType childDiploma) {
    ...
    public org.libredemat.business.request.military.ChildDiplomaType getChildDiploma() {
    ...
    private org.libredemat.business.users.FullNationalityType childOtherCountry;

    public void setChildOtherCountry(final org.libredemat.business.users.FullNationalityType childOtherCountry) {
    ...
    public org.libredemat.business.users.FullNationalityType getChildOtherCountry() {
    ...
    private org.libredemat.business.users.CountryType childResidenceCountry;

    public void setChildResidenceCountry(final org.libredemat.business.users.CountryType childResidenceCountry) {
    ...
    public org.libredemat.business.users.CountryType getChildResidenceCountry() {
    ...
    private org.libredemat.business.request.military.ChildSituationType childSituation;

    public void setChildSituation(final org.libredemat.business.request.military.ChildSituationType childSituation) {
    ...
    public org.libredemat.business.request.military.ChildSituationType getChildSituation() {
    ...
    private org.libredemat.business.users.FamilyStatusType childStatus;

    public void setChildStatus(final org.libredemat.business.users.FamilyStatusType childStatus) {
    ...
    public org.libredemat.business.users.FamilyStatusType getChildStatus() {
    ...
    private org.libredemat.business.users.TitleType childTitle;

    public void setChildTitle(final org.libredemat.business.users.TitleType childTitle) {
    ...
    public org.libredemat.business.users.TitleType getChildTitle() {
    ...
    private org.libredemat.business.users.CountryType fatherBirthCountry;

    public void setFatherBirthCountry(final org.libredemat.business.users.CountryType fatherBirthCountry) {
    ...
    public org.libredemat.business.users.CountryType getFatherBirthCountry() {
    ...
    private org.libredemat.business.users.InseeDepartementCodeType fatherBirthDepartment;

    public void setFatherBirthDepartment(final org.libredemat.business.users.InseeDepartementCodeType fatherBirthDepartment) {
    ...
    public org.libredemat.business.users.InseeDepartementCodeType getFatherBirthDepartment() {
    ...
    private org.libredemat.business.users.FullNationalityType fatherNationality;

    public void setFatherNationality(final org.libredemat.business.users.FullNationalityType fatherNationality) {
    ...
    public org.libredemat.business.users.FullNationalityType getFatherNationality() {
    ...
    private org.libredemat.business.users.CountryType motherBirthCountry;

    public void setMotherBirthCountry(final org.libredemat.business.users.CountryType motherBirthCountry) {
    ...
    public org.libredemat.business.users.CountryType getMotherBirthCountry() {
    ...
    private org.libredemat.business.users.InseeDepartementCodeType motherBirthDepartment;

    public void setMotherBirthDepartment(final org.libredemat.business.users.InseeDepartementCodeType motherBirthDepartment) {
    ...
    public org.libredemat.business.users.InseeDepartementCodeType getMotherBirthDepartment() {
    ...
    private org.libredemat.business.users.FullNationalityType motherNationality;

    public void setMotherNationality(final org.libredemat.business.users.FullNationalityType motherNationality) {
    ...
    public org.libredemat.business.users.FullNationalityType getMotherNationality() {
    ...
    private org.libredemat.business.users.InseeDepartementCodeType prefectPupilDepartment;

    public void setPrefectPupilDepartment(final org.libredemat.business.users.InseeDepartementCodeType prefectPupilDepartment) {
    ...
    public org.libredemat.business.users.InseeDepartementCodeType getPrefectPupilDepartment() {
