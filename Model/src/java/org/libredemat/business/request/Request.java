...
public class Request implements Serializable {
    ...
    public XmlObject modelToXml() {
        org.libredemat.xml.common.RequestType requestType =
            org.libredemat.xml.common.RequestType.Factory.newInstance();
    ...
    public org.libredemat.xml.common.RequestType modelToXmlRequest() {
        return (org.libredemat.xml.common.RequestType)modelToXml();
    }

    public void fillCommonXmlInfo(org.libredemat.xml.common.RequestType requestType) {
        ...
        if (getState() != null)
            requestType.setState(org.libredemat.xml.common.RequestStateType.Enum.forString(getState().toString()));
        if (getDataState() != null)
            requestType.setDataState(org.libredemat.xml.common.DataStateType.Enum.forString(getDataState().toString()));
        if (getMeansOfContact() != null)
            requestType.setMeansOfContact(MeansOfContact.modelToXml(getMeansOfContact()));
        if (getStep() != null)
            requestType.setStep(org.libredemat.xml.common.RequestType.Step.Enum.forString(getStep().toString()));
