...
public class AlignmentCertificateRequest extends Request implements Serializable {
    ...
    public final AlignmentCertificateRequestDocument modelToXml() {
        ...
        if (getRequesterQuality() != null)
            alignmentCertificateRequest.setRequesterQuality(org.libredemat.xml.request.urbanism.AcrRequesterQualityType.Enum.forString(getRequesterQuality().getLegacyLabel()));
    ...
    public static AlignmentCertificateRequest xmlToModel(AlignmentCertificateRequestDocument alignmentCertificateRequestDoc) {
        ...
        if (alignmentCertificateRequestXml.getRequesterQuality() != null)
            alignmentCertificateRequest.setRequesterQuality(org.libredemat.business.request.urbanism.AcrRequesterQualityType.forString(alignmentCertificateRequestXml.getRequesterQuality().toString()));
        else
            alignmentCertificateRequest.setRequesterQuality(org.libredemat.business.request.urbanism.AcrRequesterQualityType.getDefaultAcrRequesterQualityType());
    ...
    public final void setRequesterQuality(final org.libredemat.business.request.urbanism.AcrRequesterQualityType requesterQuality) {
        alignmentCertificateRequestData.setRequesterQuality(requesterQuality);
    }

    
    public final org.libredemat.business.request.urbanism.AcrRequesterQualityType getRequesterQuality() {
