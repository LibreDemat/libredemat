...
public class AlignmentNumberingConnectionRequest extends Request implements Serializable {
    ...
    public final AlignmentNumberingConnectionRequestDocument modelToXml() {
        ...
        if (getRequesterQuality() != null)
            alignmentNumberingConnectionRequest.setRequesterQuality(org.libredemat.xml.request.urbanism.AncrRequesterQualityType.Enum.forString(getRequesterQuality().getLegacyLabel()));
    ...
    public static AlignmentNumberingConnectionRequest xmlToModel(AlignmentNumberingConnectionRequestDocument alignmentNumberingConnectionRequestDoc) {
        ...
        if (alignmentNumberingConnectionRequestXml.getRequesterQuality() != null)
            alignmentNumberingConnectionRequest.setRequesterQuality(org.libredemat.business.request.urbanism.AncrRequesterQualityType.forString(alignmentNumberingConnectionRequestXml.getRequesterQuality().toString()));
        else
            alignmentNumberingConnectionRequest.setRequesterQuality(org.libredemat.business.request.urbanism.AncrRequesterQualityType.getDefaultAncrRequesterQualityType());
    ...
    public final void setOtherAddress(final org.libredemat.business.users.Address otherAddress) {
        alignmentNumberingConnectionRequestData.setOtherAddress(otherAddress);
    }

    
    public final org.libredemat.business.users.Address getOtherAddress() {
    ...
    public final void setRequesterQuality(final org.libredemat.business.request.urbanism.AncrRequesterQualityType requesterQuality) {
        alignmentNumberingConnectionRequestData.setRequesterQuality(requesterQuality);
    }

    
    public final org.libredemat.business.request.urbanism.AncrRequesterQualityType getRequesterQuality() {
