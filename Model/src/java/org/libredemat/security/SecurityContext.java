 ...
 * {@link org.libredemat.business.authority.Agent}, the
 * current {@link org.libredemat.business.authority.LocalAuthority}, etc.
 *
...
public class SecurityContext {
    ...
    public static void resetProxyAgent() throws CvqException{
        logger.debug("reset proxy agent");
        CredentialBean credentialBean = currentContextThreadLocal.get();
        if (credentialBean == null)
            throw new CvqException("security.error.siteMustBeSetBeforeAgent");
        ...
        credentialBean.setProxyAgent(null);
    }
    /**
