...
public interface IExternalProviderService extends IWorkflowEventVisitor{
     ...
     * Answer false to let LibreDemat handle the traces (it was the old behavior).
     */
    boolean handlesTraces();

    /**
     * Check the coherence of LibreDemat's local referentials and external service's referentials.
     * 
