...
public interface IPluginGenerator {
    ...
    String SHORT_DESC = "http://www.libredemat.org/schema/shortdesc";
    String LONG_DESC = "http://www.libredemat.org/schema/longdesc";
    String ENUM_TRANS = "http://www.libredemat.org/schema/translation/enum";

    // FIXME : make this dynamic
    String XMLBEANS_BASE_TARGET_NS = "org.libredemat.xml";
    String XMLBEANS_REFERENTIAL_NS = "common";
    String MODEL_BASE_TARGET_NS = "org.libredemat.business";
