<div id="requestTypeForms" class="yui-navset yellow-yui-tabview" style="display:block;">
    ...
    <li class="selected" title="active">
      <a href="#confArea_Tab1"><em>Gestion de compte</em></a>
    </li>
  </ul>
  <div class="yui-content">
    <h2>${message(code:'requestType.header.formsList')} <span>${message(code:'requestType.header.homefolderFormsList')}</span></h2>
  ...
  <div id="templatePanel">
    ...
    <div class="bd" >
      <div id="templateBody" style="display:none">
        ...
        <input type="hidden" name="requestTypeId" value="0" />
