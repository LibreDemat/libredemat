        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dd><span>${subjectIsChild && !subject?.born ? message(code:'request.subject.childNoBorn', args:[subject?.getFullName()]) : subject?.fullName}</span></dd>
                  ...
                  <dt class="required condition-isNonEuropean-trigger">${message(code:'dhr.property.dhrRequesterNationality.label')} &nbsp;*&nbsp;:</dt><dd id="dhrRequesterNationality" class="action-editField validate-libredematEnum required-true i18n-dhr.property.dhrRequesterNationality javatype-org.libredemat.business.users.NationalityType maxLength-32" ><g:libredematEnumToField var="${rqt?.dhrRequesterNationality}" i18nKeyPrefix="dhr.property.dhrRequesterNationality" /></dd>
              ...
              <dl class="required">
                  ...
                  <dt class="required condition-isOtherPensionPlan-trigger">${message(code:'dhr.property.dhrPrincipalPensionPlan.label')} &nbsp;*&nbsp;:</dt><dd id="dhrPrincipalPensionPlan" class="action-editField validate-libredematEnum required-true i18n-dhr.property.dhrPrincipalPensionPlan javatype-org.libredemat.business.request.social.DhrPrincipalPensionPlanType" ><g:libredematEnumToField var="${rqt?.dhrPrincipalPensionPlan}" i18nKeyPrefix="dhr.property.dhrPrincipalPensionPlan" /></dd>
          ...
          <div class="yui-u">
              ...
              <dl class="required">
                  ...
                  <dt class="required condition-haveGuardian-filled">${message(code:'dhr.property.dhrGuardianMeasure.label')} &nbsp;*&nbsp;:</dt><dd id="dhrGuardianMeasure" class="action-editField validate-libredematEnum required-true i18n-dhr.property.dhrGuardianMeasure javatype-org.libredemat.business.request.social.DhrGuardianMeasureType" ><g:libredematEnumToField var="${rqt?.dhrGuardianMeasure}" i18nKeyPrefix="dhr.property.dhrGuardianMeasure" /></dd>
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl class="required">
                  ...
                  <dt class="required condition-isCoupleRequest-trigger">${message(code:'dhr.property.dhrRequestKind.label')} &nbsp;*&nbsp;:</dt><dd id="dhrRequestKind" class="action-editField validate-libredematEnum required-true i18n-dhr.property.dhrRequestKind javatype-org.libredemat.business.request.social.DhrRequestKindType" ><g:libredematEnumToField var="${rqt?.dhrRequestKind}" i18nKeyPrefix="dhr.property.dhrRequestKind" /></dd>
                
                  <dt class="required condition-isCoupleRequest-filled condition-isSpouseMadam-trigger">${message(code:'dhr.property.dhrSpouseTitle.label')} &nbsp;*&nbsp;:</dt><dd id="dhrSpouseTitle" class="action-editField validate-libredematEnum required-true i18n-dhr.property.dhrSpouseTitle javatype-org.libredemat.business.users.TitleType" ><g:libredematEnumToField var="${rqt?.dhrSpouseTitle}" i18nKeyPrefix="dhr.property.dhrSpouseTitle" /></dd>
                
                  <dt class="required condition-isCoupleRequest-filled">${message(code:'dhr.property.dhrSpouseFamilyStatus.label')} &nbsp;*&nbsp;:</dt><dd id="dhrSpouseFamilyStatus" class="action-editField validate-libredematEnum required-true i18n-dhr.property.dhrSpouseFamilyStatus javatype-org.libredemat.business.users.FamilyStatusType" ><g:libredematEnumToField var="${rqt?.dhrSpouseFamilyStatus}" i18nKeyPrefix="dhr.property.dhrSpouseFamilyStatus" /></dd>
              ...
              <dl class="required condition-isCoupleRequest-filled">
                  ...
                  <dt class="required condition-isSpouseRetired-filled condition-isSpouseOtherPensionPlan-trigger">${message(code:'dhr.property.dhrSpousePrincipalPensionPlan.label')} &nbsp;*&nbsp;:</dt><dd id="dhrSpousePrincipalPensionPlan" class="action-editField validate-libredematEnum required-true i18n-dhr.property.dhrSpousePrincipalPensionPlan javatype-org.libredemat.business.request.social.DhrPrincipalPensionPlanType" ><g:libredematEnumToField var="${rqt?.dhrSpousePrincipalPensionPlan}" i18nKeyPrefix="dhr.property.dhrSpousePrincipalPensionPlan" /></dd>
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl class="required">
                  ...
                  <dt class="required condition-isCurrentDwellingPlaceOfResidence-trigger">${message(code:'dhr.property.dhrCurrentDwellingKind.label')} &nbsp;*&nbsp;:</dt><dd id="dhrCurrentDwellingKind" class="action-editField validate-libredematEnum required-true i18n-dhr.property.dhrCurrentDwellingKind javatype-org.libredemat.business.request.social.DhrDwellingKindType" ><g:libredematEnumToField var="${rqt?.dhrCurrentDwellingKind}" i18nKeyPrefix="dhr.property.dhrCurrentDwellingKind" /></dd>
                  ...
                  <dt class="required condition-isCurrentDwellingPlaceOfResidence-filled">${message(code:'dhr.property.dhrCurrentDwellingStatus.label')} &nbsp;*&nbsp;:</dt><dd id="dhrCurrentDwellingStatus" class="action-editField validate-libredematEnum required-true i18n-dhr.property.dhrCurrentDwellingStatus javatype-org.libredemat.business.request.social.DhrDwellingStatusType" ><g:libredematEnumToField var="${rqt?.dhrCurrentDwellingStatus}" i18nKeyPrefix="dhr.property.dhrCurrentDwellingStatus" /></dd>
