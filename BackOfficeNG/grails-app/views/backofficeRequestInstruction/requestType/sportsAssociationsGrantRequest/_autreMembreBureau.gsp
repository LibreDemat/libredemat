  ...
  <dl class="">
      ...
      <dd id="autreMembreBureau[${listSize - 1 - index}].roleMembre" class="action-editField validate-libredematEnum required-true i18n-sagr.property.roleMembre javatype-org.libredemat.business.request.social.SagrRoleAutreMembreAssociationType" >
