        ...
        <div class="yui-g">
          ...
          <div class="yui-u">
              ...
              <dl class="required">
                  ...
                  <dt class="required condition-school-filled">${message(code:'srwrcr.property.idSchoolName.label')}&nbsp;*&nbsp;:</dt><dd id="idSchoolName" class="action-editField validate-string required-true i18n-srwrcr.property.idSchoolName" ><span>${rqt?.idSchoolName}</span></dd>
                
                  <dt class="required condition-school-filled">${message(code:'srwrcr.property.labelSchoolName.label')}&nbsp;*&nbsp;:</dt><dd id="labelSchoolName" class="action-editField validate-string required-true i18n-srwrcr.property.labelSchoolName" ><span>${rqt?.labelSchoolName}</span></dd>
