    ...
    <label class="required"><g:message code="tir.property.interventionPlace.label" /> *  <span><g:message code="tir.property.interventionPlace.help" /></span></label>
            ...
            <input  type="text" class="line1 validate-streetNumber ${rqt.stepStates['intervention'].invalidFields.contains('interventionPlace.streetNumber') ? 'validation-failed' : ''}" value="${rqt.interventionPlace?.streetNumber}" size="5" maxlength="5" id="interventionPlace_streetNumber" name="interventionPlace.streetNumber" autocomplete="off" />
            <input  type="text" class="line2 required validate-streetName ${rqt.stepStates['intervention'].invalidFields.contains('interventionPlace.streetName') ? 'validation-failed' : ''}" value="${rqt.interventionPlace?.streetName}" maxlength="32" id="interventionPlace_streetName" name="interventionPlace.streetName" title="<g:message code="address.property.streetName.validationError" />" autocomplete="off" />
            ...
            <input  type="text" class="line1 required validate-postalCode ${rqt.stepStates['intervention'].invalidFields.contains('interventionPlace.postalCode') ? 'validation-failed' : ''}" value="${rqt.interventionPlace?.postalCode}" size="5" maxlength="5" id="interventionPlace_postalCode" name="interventionPlace.postalCode" title="<g:message code="address.property.postalCode.validationError" />" autocomplete="off" />
            <input  type="text" class="line2 required validate-city ${rqt.stepStates['intervention'].invalidFields.contains('interventionPlace.city') ? 'validation-failed' : ''}" value="${rqt.interventionPlace?.city}" maxlength="32" id="interventionPlace_city" name="interventionPlace.city" title="<g:message code="address.property.city.validationError" />" autocomplete="off" />
