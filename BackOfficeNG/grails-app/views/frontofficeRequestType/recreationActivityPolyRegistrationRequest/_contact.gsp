    ...
    <g:if test="${true && !isEdition}">
      <p>
        ...
        <a href="${createLink(controller : 'frontofficeRequest', action : 'edit', params:['id':rqt.id, 'currentStep':'contact', 'currentCollection':'contactPolyIndividuals', 'collectionIndex':(rqt.contactPolyIndividuals ? rqt.contactPolyIndividuals.size() : 0)])}" style="font-size:1.3em;" />
    ...
    <g:each var="it" in="${rqt.contactPolyIndividuals}" status="index">
      <div class="item">
        ...
        <dd class="head">
          <a href="${createLink(controller : 'frontofficeRequest', action : 'edit', params:['id':rqt.id, 'currentStep':'contact', 'currentCollection':'contactPolyIndividuals', 'collectionIndex':index])}">
