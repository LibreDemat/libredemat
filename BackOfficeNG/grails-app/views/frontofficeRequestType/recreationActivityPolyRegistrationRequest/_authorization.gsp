    ...
    <g:if test="${true && !isEdition}">
      <p>
        ...
        <a href="${createLink(controller : 'frontofficeRequest', action : 'edit',            params:['id':rqt.id, 'currentStep':'authorization', 'currentCollection':'authorizedPolyIndividuals',
                    'collectionIndex':(rqt.authorizedPolyIndividuals ? rqt.authorizedPolyIndividuals.size() : 0),
    ...
    <g:each var="it" in="${rqt.authorizedPolyIndividuals}" status="index">
      <div class="item">
        ...
        <dd class="head">
          <a href="${createLink(controller : 'frontofficeRequest', action : 'edit', params:['id':rqt.id, 'currentStep':'authorization', 'currentCollection':'authorizedPolyIndividuals', 'collectionIndex':index, 'collectionIndexAdded':collectionIndexAdded, 'collectionSpecific' : collectionSpecific])}">
