  ...
  <head>
    ...
    <g:if test="${specificConfigurationData}">
      <script type="text/javascript">
        zenexity.libredemat.raprrSpecificConfigurationData = ${specificConfigurationData};
      </script>
    </g:if>
    <script type="text/javascript">
  ...
  <body>
    ...
    <div id="request" class="main-box ${rqt.requestType.displayGroup == null ? '' : rqt.requestType.displayGroup.name}">
      <h2>
        ...
        <g:message code="raprr.label" /> <g:message code="message.number" args="[rqt.id]" />
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="raprr" scope="request" />
