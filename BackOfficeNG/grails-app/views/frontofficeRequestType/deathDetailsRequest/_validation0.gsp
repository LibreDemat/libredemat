    ...
    <h3>${message(code:'ddr.step.homeFolder.label')}</h3>
        ...
        <dt><g:message code="ddr.property.format.label" /></dt>
          <dd>
            <g:if test="${rqt.format}">
              <g:libredematEnumToField var="${rqt.format}" i18nKeyPrefix="ddr.property.format" />
            </g:if>
          </dd>
        ...
        <dt><g:message code="ddr.property.motive.label" /></dt>
          <dd>
            <g:if test="${rqt.motive}">
              <g:libredematEnumToField var="${rqt.motive}" i18nKeyPrefix="ddr.property.motive" />
            </g:if>
          </dd>
