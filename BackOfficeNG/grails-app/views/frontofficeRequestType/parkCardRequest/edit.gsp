...
<html>
  <head>
     <title>${message(code:'pcr.description')}</title>
    ...
    <g:if test="${specificConfigurationData}">
      <script type="text/javascript">
        zenexity.libredemat.pcrSpecificConfigurationData = ${specificConfigurationData};
      </script>
    </g:if>
    <script type="text/javascript">
  ...
  <body>
    ...
    <div id="request" class="main-box ${rqt.requestType.displayGroup == null ? '' : rqt.requestType.displayGroup.name}">
      <h2>
        ...
        <g:message code="pcr.label" /> <g:message code="message.number" args="[rqt.id]" />
      ...
      <p><g:message code="request.duration.label" /><strong> : <g:message code="pcr.duration.value" /></strong></p>
      <p>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="pcr" scope="request" />
      ...
      <g:set var="stepNumber" value="1"/>
        ...
        <li class="${currentStep == 'subject' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'pcr.step.subject.label'}" />
        ...
        <li class="${currentStep == 'car' ? 'current ' : ''}
          
            ${rqt.stepStates['car'].state}
          "
          >
          <span class="number">${stepNumber++}</span>
          <a
            <g:if test="${currentStep != 'car' && rqt.stepStates['car'].state != 'unavailable'}">
              href="${createLink(controller:'frontofficeRequest', action : 'edit', params:['id':rqt.id,'currentStep':'car'])}"
            </g:if>
          >
            
              <g:message code="pcr.step.car.label" /> *
              <span class="help">
                
                  <g:message code="request.step.message.${rqt.stepStates['car'].state}" />
