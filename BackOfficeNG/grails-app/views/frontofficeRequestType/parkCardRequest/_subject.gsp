    ...
    <label class="required"><g:message code="pcr.property.subjectAddress.label" /> *  <span><g:message code="pcr.property.subjectAddress.help" /></span></label>
            ...
            <input disabled=disabled type="text" class="line1 validate-streetNumber ${rqt.stepStates['subject'].invalidFields.contains('subjectAddress.streetNumber') ? 'validation-failed' : ''}" value="${rqt.subjectAddress?.streetNumber}" size="5" maxlength="5" id="subjectAddress_streetNumber" name="subjectAddress.streetNumber" />
