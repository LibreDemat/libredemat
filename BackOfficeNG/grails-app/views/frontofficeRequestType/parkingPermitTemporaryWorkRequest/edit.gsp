...
<html>
  <head>
     <title>${message(code:'pptwr.description')}</title>
    ...
    <g:if test="${specificConfigurationData}">
      <script type="text/javascript">
        zenexity.libredemat.pptwrSpecificConfigurationData = ${specificConfigurationData};
      </script>
    </g:if>
    <script type="text/javascript">
  ...
  <body>
    ...
    <div id="request" class="main-box ${rqt.requestType.displayGroup == null ? '' : rqt.requestType.displayGroup.name}">
      <h2>
        ...
        <g:message code="pptwr.label" /> <g:message code="message.number" args="[rqt.id]" />
      ...
      <p><g:message code="request.duration.label" /><strong> : <g:message code="pptwr.duration.value" /></strong></p>
      <p>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="pptwr" scope="request" />
      ...
      <g:set var="stepNumber" value="1"/>
        ...
        <li class="${currentStep == 'work' ? 'current ' : ''}
            ...
            ${individual ? rqt.stepStates['work-' + params.type].state : rqt.stepStates['work'].state}
          "
          >
          ...
          >
              ...
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'pptwr.step.work.label'}" />
              ...
              <span class="help">
                <g:message code="request.step.message.${rqt.stepStates['work' + (individual ? '-' + params.type : '')].state}" />
              </span>
        ...
        <li class="${currentStep == 'reglements' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="pptwr.step.reglements.label" /> *
              <span class="help">
