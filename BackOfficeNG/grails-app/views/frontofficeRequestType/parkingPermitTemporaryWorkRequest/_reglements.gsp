        ...
        <div class="field-header-information" id="ObservationsReglement-header-information">${message(code:'pptwr.property.observationsReglement.headerInformation')}</div>
