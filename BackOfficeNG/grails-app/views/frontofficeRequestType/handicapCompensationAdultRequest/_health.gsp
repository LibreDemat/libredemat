    ...
    <legend><g:message code="hcar.property.health.label" /></legend>
      ...
      <label for="healthDoctorLastName" class="required condition-isFollowedByDoctor-filled"><g:message code="hcar.property.healthDoctorLastName.label" /> *  <span><g:message code="hcar.property.healthDoctorLastName.help" /></span></label>
            <input  type="text" id="healthDoctorLastName"
                   name="healthDoctorLastName"
                   value="${rqt.healthDoctorLastName?.toString()}"
                   class="required condition-isFollowedByDoctor-filled  validate-lastName ${rqt.stepStates['health'].invalidFields.contains('healthDoctorLastName') ? 'validation-failed' : ''}"
                   title="<g:message code="hcar.property.healthDoctorLastName.validationError" />"  maxlength="38" />
      ...
      <label for="healthDoctorFirstName" class="required condition-isFollowedByDoctor-filled"><g:message code="hcar.property.healthDoctorFirstName.label" /> *  <span><g:message code="hcar.property.healthDoctorFirstName.help" /></span></label>
            <input  type="text" id="healthDoctorFirstName"
                   name="healthDoctorFirstName"
                   value="${rqt.healthDoctorFirstName?.toString()}"
                   class="required condition-isFollowedByDoctor-filled  validate-firstName ${rqt.stepStates['health'].invalidFields.contains('healthDoctorFirstName') ? 'validation-failed' : ''}"
                   title="<g:message code="hcar.property.healthDoctorFirstName.validationError" />"  maxlength="38" />
      ...
      <label for="healthProfessionalLastName" class="required condition-isFollowedByProfessional-filled"><g:message code="hcar.property.healthProfessionalLastName.label" /> *  <span><g:message code="hcar.property.healthProfessionalLastName.help" /></span></label>
            <input  type="text" id="healthProfessionalLastName"
                   name="healthProfessionalLastName"
                   value="${rqt.healthProfessionalLastName?.toString()}"
                   class="required condition-isFollowedByProfessional-filled  validate-lastName ${rqt.stepStates['health'].invalidFields.contains('healthProfessionalLastName') ? 'validation-failed' : ''}"
                   title="<g:message code="hcar.property.healthProfessionalLastName.validationError" />"  maxlength="38" />
      ...
      <label for="healthProfessionalFirstName" class="required condition-isFollowedByProfessional-filled"><g:message code="hcar.property.healthProfessionalFirstName.label" /> *  <span><g:message code="hcar.property.healthProfessionalFirstName.help" /></span></label>
            <input  type="text" id="healthProfessionalFirstName"
                   name="healthProfessionalFirstName"
                   value="${rqt.healthProfessionalFirstName?.toString()}"
                   class="required condition-isFollowedByProfessional-filled  validate-firstName ${rqt.stepStates['health'].invalidFields.contains('healthProfessionalFirstName') ? 'validation-failed' : ''}"
                   title="<g:message code="hcar.property.healthProfessionalFirstName.validationError" />"  maxlength="38" />
      ...
      <label for="healthHospitalName" class="required condition-isFollowedByHospital-filled"><g:message code="hcar.property.healthHospitalName.label" /> *  <span><g:message code="hcar.property.healthHospitalName.help" /></span></label>
            <input  type="text" id="healthHospitalName"
                   name="healthHospitalName"
                   value="${rqt.healthHospitalName?.toString()}"
                   class="required condition-isFollowedByHospital-filled   ${rqt.stepStates['health'].invalidFields.contains('healthHospitalName') ? 'validation-failed' : ''}"
                   title="<g:message code="hcar.property.healthHospitalName.validationError" />"  maxlength="60" />
