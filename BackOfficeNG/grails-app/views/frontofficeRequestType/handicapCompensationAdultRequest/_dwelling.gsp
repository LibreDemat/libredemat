    ...
    <fieldset class="required" id="Dwelling">
    <legend><g:message code="hcar.property.dwelling.label" /></legend>
      ...
      <label for="dwellingKind" class="required"><g:message code="hcar.property.dwellingKind.label" /> *  <span><g:message code="hcar.property.dwellingKind.help" /></span></label>
            <select id="dwellingKind" name="dwellingKind" class="required condition-isNotPlaceOfResidence-trigger  validate-not-first ${rqt.stepStates['dwelling'].invalidFields.contains('dwellingKind') ? 'validation-failed' : ''}" title="<g:message code="hcar.property.dwellingKind.validationError" />">
              ...
              <g:each in="${['PLACE_OF_RESIDENCE','THIRD_PARTY_PLACE_OF_RESIDENCE','OTHER']}">
                <option value="${it}" ${it == rqt.dwellingKind?.toString() ? 'selected="selected"': ''}><g:libredematEnumToText var="${it}" i18nKeyPrefix="hcar.property.dwellingKind" /></option>
              </g:each>
            </select>
      ...
      <label for="dwellingReceptionType" class="required condition-isInEstablishmentReception-filled"><g:message code="hcar.property.dwellingReceptionType.label" /> *  <span><g:message code="hcar.property.dwellingReceptionType.help" /></span></label>
            <select id="dwellingReceptionType" name="dwellingReceptionType" class="required condition-isInEstablishmentReception-filled  validate-not-first ${rqt.stepStates['dwelling'].invalidFields.contains('dwellingReceptionType') ? 'validation-failed' : ''}" title="<g:message code="hcar.property.dwellingReceptionType.validationError" />">
              ...
              <g:each in="${['INTERNSHIP','CLERKSHIP']}">
                <option value="${it}" ${it == rqt.dwellingReceptionType?.toString() ? 'selected="selected"': ''}><g:libredematEnumToText var="${it}" i18nKeyPrefix="hcar.property.dwellingReceptionType" /></option>
              </g:each>
            </select>
      ...
      <label for="dwellingReceptionNaming" class="required condition-isInEstablishmentReception-filled"><g:message code="hcar.property.dwellingReceptionNaming.label" /> *  <span><g:message code="hcar.property.dwellingReceptionNaming.help" /></span></label>
            <input  type="text" id="dwellingReceptionNaming"
                   ...
                   title="<g:message code="hcar.property.dwellingReceptionNaming.validationError" />"  maxlength="80" />
      ...
      <label class="required condition-isInEstablishmentReception-filled"><g:message code="hcar.property.dwellingReceptionAddress.label" /> *  <span><g:message code="hcar.property.dwellingReceptionAddress.help" /></span></label>
            ...
            <input  type="text" class="line1 validate-streetNumber ${rqt.stepStates['dwelling'].invalidFields.contains('dwellingReceptionAddress.streetNumber') ? 'validation-failed' : ''}" value="${rqt.dwellingReceptionAddress?.streetNumber}" size="5" maxlength="5" id="dwellingReceptionAddress_streetNumber" name="dwellingReceptionAddress.streetNumber" autocomplete="off" />
            <input  type="text" class="line2 required validate-streetName ${rqt.stepStates['dwelling'].invalidFields.contains('dwellingReceptionAddress.streetName') ? 'validation-failed' : ''}" value="${rqt.dwellingReceptionAddress?.streetName}" maxlength="32" id="dwellingReceptionAddress_streetName" name="dwellingReceptionAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" autocomplete="off" />
            ...
            <input  type="text" class="line1 required validate-postalCode ${rqt.stepStates['dwelling'].invalidFields.contains('dwellingReceptionAddress.postalCode') ? 'validation-failed' : ''}" value="${rqt.dwellingReceptionAddress?.postalCode}" size="5" maxlength="5" id="dwellingReceptionAddress_postalCode" name="dwellingReceptionAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" autocomplete="off" />
            <input  type="text" class="line2 required validate-city ${rqt.stepStates['dwelling'].invalidFields.contains('dwellingReceptionAddress.city') ? 'validation-failed' : ''}" value="${rqt.dwellingReceptionAddress?.city}" maxlength="32" id="dwellingReceptionAddress_city" name="dwellingReceptionAddress.city" title="<g:message code="address.property.city.validationError" />" autocomplete="off" />
      ...
      <label for="dwellingSocialReceptionNaming" class="required condition-isInSocialReception-filled"><g:message code="hcar.property.dwellingSocialReceptionNaming.label" /> *  <span><g:message code="hcar.property.dwellingSocialReceptionNaming.help" /></span></label>
            <input  type="text" id="dwellingSocialReceptionNaming"
                   ...
                   title="<g:message code="hcar.property.dwellingSocialReceptionNaming.validationError" />"  maxlength="80" />
      ...
      <label class="required condition-isInSocialReception-filled"><g:message code="hcar.property.dwellingSocialReceptionAddress.label" /> *  <span><g:message code="hcar.property.dwellingSocialReceptionAddress.help" /></span></label>
            ...
            <input  type="text" class="line1 validate-streetNumber ${rqt.stepStates['dwelling'].invalidFields.contains('dwellingSocialReceptionAddress.streetNumber') ? 'validation-failed' : ''}" value="${rqt.dwellingSocialReceptionAddress?.streetNumber}" size="5" maxlength="5" id="dwellingSocialReceptionAddress_streetNumber" name="dwellingSocialReceptionAddress.streetNumber" autocomplete="off" />
            <input  type="text" class="line2 required validate-streetName ${rqt.stepStates['dwelling'].invalidFields.contains('dwellingSocialReceptionAddress.streetName') ? 'validation-failed' : ''}" value="${rqt.dwellingSocialReceptionAddress?.streetName}" maxlength="32" id="dwellingSocialReceptionAddress_streetName" name="dwellingSocialReceptionAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" autocomplete="off" />
