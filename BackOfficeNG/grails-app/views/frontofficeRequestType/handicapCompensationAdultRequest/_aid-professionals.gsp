  ...
  <h4>
    ...
    <label for="professionals.${collectionIndex}.professionalLastName" class="required"><g:message code="hcar.property.professionalLastName.label" /> *  <span><g:message code="hcar.property.professionalLastName.help" /></span></label>
            <input  type="text" id="professionals.${collectionIndex}.professionalLastName" name="professionals[${collectionIndex}].professionalLastName" value="${currentCollectionItem?.professionalLastName?.toString()}" 
                    class="required  validate-lastName ${rqt.stepStates['aid'].invalidFields.contains('professionals['+collectionIndex+'].professionalLastName') ? 'validation-failed' : ''}" title="<g:message code="hcar.property.professionalLastName.validationError" />"  maxlength="38" style="width:99%" />
    ...
    <label for="professionals.${collectionIndex}.professionalFirstName" class="required"><g:message code="hcar.property.professionalFirstName.label" /> *  <span><g:message code="hcar.property.professionalFirstName.help" /></span></label>
            <input  type="text" id="professionals.${collectionIndex}.professionalFirstName" name="professionals[${collectionIndex}].professionalFirstName" value="${currentCollectionItem?.professionalFirstName?.toString()}" 
                    class="required  validate-firstName ${rqt.stepStates['aid'].invalidFields.contains('professionals['+collectionIndex+'].professionalFirstName') ? 'validation-failed' : ''}" title="<g:message code="hcar.property.professionalFirstName.validationError" />"  maxlength="38" style="width:99%" />
    ...
    <label class="required"><g:message code="hcar.property.professionalAddress.label" />&nbsp;* <span><g:message code="hcar.property.professionalAddress.help" /></span></label>
            ...
            <input type="text" class="line2 required validate-streetName ${rqt.stepStates['aid'].invalidFields.contains('professionals['+collectionIndex+'].professionalAddress.streetName') ? 'validation-failed' : ''}" value="${currentCollectionItem?.professionalAddress?.streetName}" maxlength="32" id="professionals.${collectionIndex}.professionalAddress.streetName" name="professionals[${collectionIndex}].professionalAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" autocomplete="off" />
            ...
            <input type="text" class="line1 required validate-postalCode ${rqt.stepStates['aid'].invalidFields.contains('professionals['+collectionIndex+'].professionalAddress.postalCode') ? 'validation-failed' : ''}" value="${currentCollectionItem?.professionalAddress?.postalCode}" size="5" maxlength="5" id="professionals.${collectionIndex}.professionalAddress.postalCode" name="professionals[${collectionIndex}].professionalAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" autocomplete="off" />
            <input type="text" class="line2 required validate-city ${rqt.stepStates['aid'].invalidFields.contains('professionals['+collectionIndex+'].professionalAddress.city') ? 'validation-failed' : ''}" value="${currentCollectionItem?.professionalAddress?.city}" maxlength="32" id="professionals.${collectionIndex}.professionalAddress.city" name="professionals[${collectionIndex}].professionalAddress.city" title="<g:message code="address.property.city.validationError" />" autocomplete="off" />
