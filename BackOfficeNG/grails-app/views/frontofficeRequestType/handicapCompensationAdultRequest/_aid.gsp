    ...
    <legend><g:message code="hcar.property.socialService.label" /></legend>
      ...
      <label class="required condition-isSocialServiceSupport-filled"><g:message code="hcar.property.professionalSupportSocialServiceAddress.label" /> *  <span><g:message code="hcar.property.professionalSupportSocialServiceAddress.help" /></span></label>
            ...
            <input  type="text" class="line1 validate-streetNumber ${rqt.stepStates['aid'].invalidFields.contains('professionalSupportSocialServiceAddress.streetNumber') ? 'validation-failed' : ''}" value="${rqt.professionalSupportSocialServiceAddress?.streetNumber}" size="5" maxlength="5" id="professionalSupportSocialServiceAddress_streetNumber" name="professionalSupportSocialServiceAddress.streetNumber" autocomplete="off" />
            <input  type="text" class="line2 required validate-streetName ${rqt.stepStates['aid'].invalidFields.contains('professionalSupportSocialServiceAddress.streetName') ? 'validation-failed' : ''}" value="${rqt.professionalSupportSocialServiceAddress?.streetName}" maxlength="32" id="professionalSupportSocialServiceAddress_streetName" name="professionalSupportSocialServiceAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" autocomplete="off" />
            ...
            <input  type="text" class="line1 required validate-postalCode ${rqt.stepStates['aid'].invalidFields.contains('professionalSupportSocialServiceAddress.postalCode') ? 'validation-failed' : ''}" value="${rqt.professionalSupportSocialServiceAddress?.postalCode}" size="5" maxlength="5" id="professionalSupportSocialServiceAddress_postalCode" name="professionalSupportSocialServiceAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" autocomplete="off" />
            <input  type="text" class="line2 required validate-city ${rqt.stepStates['aid'].invalidFields.contains('professionalSupportSocialServiceAddress.city') ? 'validation-failed' : ''}" value="${rqt.professionalSupportSocialServiceAddress?.city}" maxlength="32" id="professionalSupportSocialServiceAddress_city" name="professionalSupportSocialServiceAddress.city" title="<g:message code="address.property.city.validationError" />" autocomplete="off" />
