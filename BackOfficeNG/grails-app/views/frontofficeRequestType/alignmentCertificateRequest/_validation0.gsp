    ...
    <h3>${message(code:'acr.step.homeFolder.label')}</h3>
    ...
    <h3><g:message code="acr.step.cadastre.label" /></h3>
        ...
        <dt><g:message code="acr.property.requesterQuality.label" /></dt>
          <dd>
            <g:if test="${rqt.requesterQuality}">
              <g:libredematEnumToField var="${rqt.requesterQuality}" i18nKeyPrefix="acr.property.requesterQuality" />
            </g:if>
          </dd>
      ...
      <dl>
        <dt><g:message code="acr.property.ownerLastName.label" /></dt>
      ...
      <dl>
        <dt><g:message code="acr.property.ownerFirstNames.label" /></dt>
      ...
      <dl>
        <dt><g:message code="acr.property.section.label" /></dt>
      ...
      <dl>
        <dt><g:message code="acr.property.number.label" /></dt>
      ...
      <dl>
        <dt><g:message code="acr.property.locality.label" /></dt>
      ...
      <dl>
        <dt><g:message code="acr.property.transportationRoute.label" /></dt>
