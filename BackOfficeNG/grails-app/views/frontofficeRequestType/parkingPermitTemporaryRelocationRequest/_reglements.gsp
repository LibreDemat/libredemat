        ...
        <div class="field-header-information" id="ObservationsReglement-header-information">${message(code:'pptrr.property.observationsReglement.headerInformation')}</div>
