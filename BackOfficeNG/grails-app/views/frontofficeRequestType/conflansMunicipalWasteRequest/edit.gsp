...
<html>
  <head>
     <title>${message(code:'cmwr.description')}</title>
  ...
  <body>
    ...
    <div id="request" class="main-box ${rqt.requestType.displayGroup == null ? '' : rqt.requestType.displayGroup.name}">
      <h2>
        ...
        <g:message code="cmwr.label" /> <g:message code="message.number" args="[rqt.id]" />
      ...
      <p><g:message code="request.duration.label" /><strong> : <g:message code="cmwr.duration.value" /></strong></p>
      <p>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="cmwr" scope="request" />
      ...
      <g:set var="stepNumber" value="1"/>
        ...
        <li class="${currentStep == 'informations' ? 'current ' : ''}
            ...
            ${individual ? rqt.stepStates['informations-' + params.type].state : rqt.stepStates['informations'].state}
          "
          >
          ...
          >
              ...
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'cmwr.step.informations.label'}" />
              ...
              <span class="help">
                <g:message code="request.step.message.${rqt.stepStates['informations' + (individual ? '-' + params.type : '')].state}" />
              </span>
