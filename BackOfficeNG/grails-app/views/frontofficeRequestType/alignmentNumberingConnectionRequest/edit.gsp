  ...
  <head>
    ...
    <g:if test="${specificConfigurationData}">
      <script type="text/javascript">
        zenexity.libredemat.ancrSpecificConfigurationData = ${specificConfigurationData};
      </script>
    </g:if>
    <script type="text/javascript">
      ...
      <g:set var="stepNumber" value="1"/>
        ...
        <li class="${currentStep == 'address' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="ancr.step.address.label" /> *
              <span class="help">
                
                  <g:message code="request.step.message.${rqt.stepStates['address'].state}" />
