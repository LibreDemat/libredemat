    ...
    <label class="required"><g:message code="bgr.property.subjectAddress.label" /> *  <span><g:message code="bgr.property.subjectAddress.help" /></span></label>
            ...
            <input  type="text" class="line1 validate-streetNumber ${rqt.stepStates['subject'].invalidFields.contains('subjectAddress.streetNumber') ? 'validation-failed' : ''}" value="${rqt.subjectAddress?.streetNumber}" size="5" maxlength="5" id="subjectAddress_streetNumber" name="subjectAddress.streetNumber" autocomplete="off" />
