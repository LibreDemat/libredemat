  ...
  <h4>
    ...
    <label for="contactIndividuals.${collectionIndex}.lastName" class="required"><g:message code="parr.property.lastName.label" /> *  <span><g:message code="parr.property.lastName.help" /></span></label>
            <input  type="text" id="contactIndividuals.${collectionIndex}.lastName" name="contactIndividuals[${collectionIndex}].lastName" value="${currentCollectionItem?.lastName?.toString()}" 
                    class="required  validate-lastName ${rqt.stepStates['contact'].invalidFields.contains('contactIndividuals['+collectionIndex+'].lastName') ? 'validation-failed' : ''}" title="<g:message code="parr.property.lastName.validationError" />"  maxlength="38" style="width:99%" />
    ...
    <label for="contactIndividuals.${collectionIndex}.firstName" class="required"><g:message code="parr.property.firstName.label" /> *  <span><g:message code="parr.property.firstName.help" /></span></label>
            <input  type="text" id="contactIndividuals.${collectionIndex}.firstName" name="contactIndividuals[${collectionIndex}].firstName" value="${currentCollectionItem?.firstName?.toString()}" 
                    class="required  validate-firstName ${rqt.stepStates['contact'].invalidFields.contains('contactIndividuals['+collectionIndex+'].firstName') ? 'validation-failed' : ''}" title="<g:message code="parr.property.firstName.validationError" />"  maxlength="38" style="width:99%" />
    ...
    <label class="required"><g:message code="parr.property.address.label" />&nbsp;* <span><g:message code="parr.property.address.help" /></span></label>
            ...
            <input type="text" class="line1 validate-streetNumber ${rqt.stepStates['contact'].invalidFields.contains('contactIndividuals['+collectionIndex+'].address.streetNumber') ? 'validation-failed' : ''}" value="${currentCollectionItem?.address?.streetNumber}" size="5" maxlength="5" id="contactIndividuals.${collectionIndex}.address.streetNumber" name="contactIndividuals[${collectionIndex}].address.streetNumber" autocomplete="off" />
            <input type="text" class="line2 required validate-streetName ${rqt.stepStates['contact'].invalidFields.contains('contactIndividuals['+collectionIndex+'].address.streetName') ? 'validation-failed' : ''}" value="${currentCollectionItem?.address?.streetName}" maxlength="32" id="contactIndividuals.${collectionIndex}.address.streetName" name="contactIndividuals[${collectionIndex}].address.streetName" title="<g:message code="address.property.streetName.validationError" />" autocomplete="off" />
            ...
            <input type="text" class="line1 required validate-postalCode ${rqt.stepStates['contact'].invalidFields.contains('contactIndividuals['+collectionIndex+'].address.postalCode') ? 'validation-failed' : ''}" value="${currentCollectionItem?.address?.postalCode}" size="5" maxlength="5" id="contactIndividuals.${collectionIndex}.address.postalCode" name="contactIndividuals[${collectionIndex}].address.postalCode" title="<g:message code="address.property.postalCode.validationError" />" autocomplete="off" />
            <input type="text" class="line2 required validate-city ${rqt.stepStates['contact'].invalidFields.contains('contactIndividuals['+collectionIndex+'].address.city') ? 'validation-failed' : ''}" value="${currentCollectionItem?.address?.city}" maxlength="32" id="contactIndividuals.${collectionIndex}.address.city" name="contactIndividuals[${collectionIndex}].address.city" title="<g:message code="address.property.city.validationError" />" autocomplete="off" />
    ...
    <label for="contactIndividuals.${collectionIndex}.homePhone" class=""><g:message code="parr.property.homePhone.label" />   <span><g:message code="parr.property.homePhone.help" /></span></label>
            <input  type="text" id="contactIndividuals.${collectionIndex}.homePhone" name="contactIndividuals[${collectionIndex}].homePhone" value="${currentCollectionItem?.homePhone?.toString()}" 
                    class="  validate-phone ${rqt.stepStates['contact'].invalidFields.contains('contactIndividuals['+collectionIndex+'].homePhone') ? 'validation-failed' : ''}" title="<g:message code="parr.property.homePhone.validationError" />"  maxlength="10" style="width:99%" />
    ...
    <label for="contactIndividuals.${collectionIndex}.officePhone" class=""><g:message code="parr.property.officePhone.label" />   <span><g:message code="parr.property.officePhone.help" /></span></label>
            <input  type="text" id="contactIndividuals.${collectionIndex}.officePhone" name="contactIndividuals[${collectionIndex}].officePhone" value="${currentCollectionItem?.officePhone?.toString()}" 
                    class="  validate-phone ${rqt.stepStates['contact'].invalidFields.contains('contactIndividuals['+collectionIndex+'].officePhone') ? 'validation-failed' : ''}" title="<g:message code="parr.property.officePhone.validationError" />"  maxlength="10" style="width:99%" />
