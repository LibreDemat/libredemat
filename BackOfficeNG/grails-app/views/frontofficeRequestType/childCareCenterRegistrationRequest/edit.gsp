  ...
  <head>
    ...
    <g:if test="${specificConfigurationData}">
      <script type="text/javascript">
        zenexity.libredemat.cccrrSpecificConfigurationData = ${specificConfigurationData};
      </script>
    </g:if>
    <script type="text/javascript">
    ...
    <div id="request" class="main-box ${rqt.requestType.displayGroup == null ? '' : rqt.requestType.displayGroup.name}">
      ...
      <g:set var="stepNumber" value="1"/>
        ...
        <li class="${currentStep == 'registrationSubject' ? 'current ' : ''}
            ...
            ${rqt.stepStates['registrationSubject'].state}
          "
          >
          <span class="number">${stepNumber++}</span>
          <a
          ...
          >
              ...
              <span class="help">
                  ...
                  <g:message code="request.step.message.${rqt.stepStates['registrationSubject'].state}" />
