...
<html>
  <head>
     <title>${message(code:'srwrcr.description')}</title>
    ...
    <g:if test="${specificConfigurationData}">
      <script type="text/javascript">
        zenexity.libredemat.srwrcrSpecificConfigurationData = ${specificConfigurationData};
      </script>
    </g:if>
    <script type="text/javascript">
  ...
  <body>
    ...
    <div id="request" class="main-box ${rqt.requestType.displayGroup == null ? '' : rqt.requestType.displayGroup.name}">
      <h2>
        ...
        <g:message code="srwrcr.label" /> <g:message code="message.number" args="[rqt.id]" />
      ...
      <p><g:message code="request.duration.label" /><strong> : <g:message code="srwrcr.duration.value" /></strong></p>
      <p>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="srwrcr" scope="request" />
      ...
      <g:set var="stepNumber" value="1"/>
        ...
        <li class="${currentStep == 'rules' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="srwrcr.step.rules.label" /> *
              <span class="help">
