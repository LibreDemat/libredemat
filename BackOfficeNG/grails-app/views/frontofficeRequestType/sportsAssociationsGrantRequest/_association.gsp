    ...
    <label class="required"><g:message code="sagr.property.siegeSocialAssociation.label" /> *  <span><g:message code="sagr.property.siegeSocialAssociation.help" /></span></label>
            ...
            <input  type="text" class="line1 validate-streetNumber ${rqt.stepStates['association'].invalidFields.contains('siegeSocialAssociation.streetNumber') ? 'validation-failed' : ''}" value="${rqt.siegeSocialAssociation?.streetNumber}" size="5" maxlength="5" id="siegeSocialAssociation_streetNumber" name="siegeSocialAssociation.streetNumber" autocomplete="off" />
            <input  type="text" class="line2 required validate-streetName ${rqt.stepStates['association'].invalidFields.contains('siegeSocialAssociation.streetName') ? 'validation-failed' : ''}" value="${rqt.siegeSocialAssociation?.streetName}" maxlength="32" id="siegeSocialAssociation_streetName" name="siegeSocialAssociation.streetName" title="<g:message code="address.property.streetName.validationError" />" autocomplete="off" />
            ...
            <input  type="text" class="line1 required validate-postalCode ${rqt.stepStates['association'].invalidFields.contains('siegeSocialAssociation.postalCode') ? 'validation-failed' : ''}" value="${rqt.siegeSocialAssociation?.postalCode}" size="5" maxlength="5" id="siegeSocialAssociation_postalCode" name="siegeSocialAssociation.postalCode" title="<g:message code="address.property.postalCode.validationError" />" autocomplete="off" />
            <input  type="text" class="line2 required validate-city ${rqt.stepStates['association'].invalidFields.contains('siegeSocialAssociation.city') ? 'validation-failed' : ''}" value="${rqt.siegeSocialAssociation?.city}" maxlength="32" id="siegeSocialAssociation_city" name="siegeSocialAssociation.city" title="<g:message code="address.property.city.validationError" />" autocomplete="off" />
    ...
    <fieldset class="required" id="NumerosAssociation">
    ...
    <fieldset class="required" id="ContactsAssociation">
    <legend><g:message code="sagr.property.contactsAssociation.label" /></legend>
      ...
      <label class="required condition-estAdresseCorrespondantPrincipal-filled"><g:message code="sagr.property.adresseCorrespondantPrincipal.label" /> *  <span><g:message code="sagr.property.adresseCorrespondantPrincipal.help" /></span></label>
            ...
            <input  type="text" class="line1 validate-streetNumber ${rqt.stepStates['association'].invalidFields.contains('adresseCorrespondantPrincipal.streetNumber') ? 'validation-failed' : ''}" value="${rqt.adresseCorrespondantPrincipal?.streetNumber}" size="5" maxlength="5" id="adresseCorrespondantPrincipal_streetNumber" name="adresseCorrespondantPrincipal.streetNumber" autocomplete="off" />
            <input  type="text" class="line2 required validate-streetName ${rqt.stepStates['association'].invalidFields.contains('adresseCorrespondantPrincipal.streetName') ? 'validation-failed' : ''}" value="${rqt.adresseCorrespondantPrincipal?.streetName}" maxlength="32" id="adresseCorrespondantPrincipal_streetName" name="adresseCorrespondantPrincipal.streetName" title="<g:message code="address.property.streetName.validationError" />" autocomplete="off" />
            ...
            <input  type="text" class="line1 required validate-postalCode ${rqt.stepStates['association'].invalidFields.contains('adresseCorrespondantPrincipal.postalCode') ? 'validation-failed' : ''}" value="${rqt.adresseCorrespondantPrincipal?.postalCode}" size="5" maxlength="5" id="adresseCorrespondantPrincipal_postalCode" name="adresseCorrespondantPrincipal.postalCode" title="<g:message code="address.property.postalCode.validationError" />" autocomplete="off" />
            <input  type="text" class="line2 required validate-city ${rqt.stepStates['association'].invalidFields.contains('adresseCorrespondantPrincipal.city') ? 'validation-failed' : ''}" value="${rqt.adresseCorrespondantPrincipal?.city}" maxlength="32" id="adresseCorrespondantPrincipal_city" name="adresseCorrespondantPrincipal.city" title="<g:message code="address.property.city.validationError" />" autocomplete="off" />
