  ...
  <head>
    ...
    <g:if test="${specificConfigurationData}">
      <script type="text/javascript">
        zenexity.libredemat.sagrSpecificConfigurationData = ${specificConfigurationData};
      </script>
    </g:if>
    <script type="text/javascript">
    ...
    <div id="request" class="main-box ${rqt.requestType.displayGroup == null ? '' : rqt.requestType.displayGroup.name}">
      ...
      <g:set var="stepNumber" value="1"/>
        ...
        <li class="${currentStep == 'association' ? 'current ' : ''}
            ...
            ${rqt.stepStates['association'].state}
          "
          >
          <span class="number">${stepNumber++}</span>
          <a
          ...
          >
              ...
              <g:message code="sagr.step.association.label" /> *
              <span class="help">
                
                  <g:message code="request.step.message.${rqt.stepStates['association'].state}" />
