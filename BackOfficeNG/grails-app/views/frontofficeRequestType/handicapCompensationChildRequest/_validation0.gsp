    ...
    <h3>${message(code:'hccr.step.homeFolder.label')}</h3>
    ...
    <h3><g:message code="hccr.step.subject.label" /></h3>
      ...
      <dl>
          ...
          <dd>${rqt.fatherActivityReductionRatio?.toString()}</dd>
      ...
      <dl>
          ...
          <dd>${rqt.motherActivityReductionRatio?.toString()}</dd>
      ...
      <dl>
          ...
          <dd>${rqt.aseReferentLastName?.toString()}</dd>
          

        
          <dt><g:message code="hccr.property.aseReferentDepartment.label" /></dt>
          <dd>${rqt.aseReferentDepartment?.toString()}</dd>
      ...
      <dl>
          ...
          <dd>${rqt.referentLastName?.toString()}</dd>
          

        
          <dt><g:message code="hccr.property.referentFirstName.label" /></dt>
          <dd>${rqt.referentFirstName?.toString()}</dd>
          ...
          <dd>${rqt.referentMaidenName?.toString()}</dd>
          ...
          <dd>${rqt.referentBirthCity?.toString()}</dd>
          

        
          <dt><g:message code="hccr.property.referentBirthCountry.label" /></dt>
          <dd>${rqt.referentBirthCountry?.toString()}</dd>
    ...
    <h3><g:message code="hccr.step.occupationnalAndSchoolStatus.label" /></h3>
      ...
      <dl>
          ...
          <dd>${rqt.schoolingSchoolName?.toString()}</dd>
          ...
          <dd>${rqt.schoolingSpecializedGradeDetails?.toString()}</dd>
          ...
          <dd>${rqt.schoolingTime?.toString()}</dd>
          ...
          <dd>${rqt.schoolingHomeSchoolingAccompanistLastName?.toString()}</dd>
          

        
          <dt><g:message code="hccr.property.schoolingHomeSchoolingAccompanistFirstName.label" /></dt>
          <dd>${rqt.schoolingHomeSchoolingAccompanistFirstName?.toString()}</dd>
          ...
          <dd>${rqt.schoolingExtraCurricularDetails?.toString()}</dd>
