    ...
    <fieldset class="required condition-isOtherContact-filled" id="OtherContactInformations">
    <legend><g:message code="hsr.property.otherContactInformations.label" /></legend>
      ...
      <label class="required"><g:message code="hsr.property.otherContactAddress.label" /> *  <span><g:message code="hsr.property.otherContactAddress.help" /></span></label>
            ...
            <input  type="text" class="line1 validate-streetNumber ${rqt.stepStates['contact'].invalidFields.contains('otherContactAddress.streetNumber') ? 'validation-failed' : ''}" value="${rqt.otherContactAddress?.streetNumber}" size="5" maxlength="5" id="otherContactAddress_streetNumber" name="otherContactAddress.streetNumber" autocomplete="off" />
            <input  type="text" class="line2 required validate-streetName ${rqt.stepStates['contact'].invalidFields.contains('otherContactAddress.streetName') ? 'validation-failed' : ''}" value="${rqt.otherContactAddress?.streetName}" maxlength="32" id="otherContactAddress_streetName" name="otherContactAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" autocomplete="off" />
            ...
            <input  type="text" class="line1 required validate-postalCode ${rqt.stepStates['contact'].invalidFields.contains('otherContactAddress.postalCode') ? 'validation-failed' : ''}" value="${rqt.otherContactAddress?.postalCode}" size="5" maxlength="5" id="otherContactAddress_postalCode" name="otherContactAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" autocomplete="off" />
            <input  type="text" class="line2 required validate-city ${rqt.stepStates['contact'].invalidFields.contains('otherContactAddress.city') ? 'validation-failed' : ''}" value="${rqt.otherContactAddress?.city}" maxlength="32" id="otherContactAddress_city" name="otherContactAddress.city" title="<g:message code="address.property.city.validationError" />" autocomplete="off" />
