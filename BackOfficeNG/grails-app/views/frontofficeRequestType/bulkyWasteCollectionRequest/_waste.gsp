    ...
    <label for="otherWaste" class=""><g:message code="bwcr.property.otherWaste.label" />   <span><g:message code="bwcr.property.otherWaste.help" /></span></label>
            <input  type="text" id="otherWaste"
                   name="otherWaste"
                   value="${rqt.otherWaste?.toString()}"
                   class="  validate-string ${rqt.stepStates['waste'].invalidFields.contains('otherWaste') ? 'validation-failed' : ''}"
                   title="<g:message code="bwcr.property.otherWaste.validationError" />"   />
    ...
    <label class=""><g:message code="bwcr.property.collectionAddress.label" />   <span><g:message code="bwcr.property.collectionAddress.help" /></span></label>
            ...
            <input  type="text" class="line1 validate-streetNumber ${rqt.stepStates['waste'].invalidFields.contains('collectionAddress.streetNumber') ? 'validation-failed' : ''}" value="${rqt.collectionAddress?.streetNumber}" size="5" maxlength="5" id="collectionAddress_streetNumber" name="collectionAddress.streetNumber" autocomplete="off" />
            <input  type="text" class="line2 required validate-streetName ${rqt.stepStates['waste'].invalidFields.contains('collectionAddress.streetName') ? 'validation-failed' : ''}" value="${rqt.collectionAddress?.streetName}" maxlength="32" id="collectionAddress_streetName" name="collectionAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" autocomplete="off" />
            ...
            <input  type="text" class="line1 required validate-postalCode ${rqt.stepStates['waste'].invalidFields.contains('collectionAddress.postalCode') ? 'validation-failed' : ''}" value="${rqt.collectionAddress?.postalCode}" size="5" maxlength="5" id="collectionAddress_postalCode" name="collectionAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" autocomplete="off" />
            <input  type="text" class="line2 required validate-city ${rqt.stepStates['waste'].invalidFields.contains('collectionAddress.city') ? 'validation-failed' : ''}" value="${rqt.collectionAddress?.city}" maxlength="32" id="collectionAddress_city" name="collectionAddress.city" title="<g:message code="address.property.city.validationError" />" autocomplete="off" />
