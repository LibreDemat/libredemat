    ...
    <label for="registrationNumber" class=""><g:message code="lrr.property.registrationNumber.label" />   <span><g:message code="lrr.property.registrationNumber.help" /></span></label>
            <input  type="text" id="registrationNumber"
                   ...
                   value="${rqt.registrationNumber?.toString()}"
                   class="  validate-string ${rqt.stepStates['registration'].invalidFields.contains('registrationNumber') ? 'validation-failed' : ''}"
                   title="<g:message code="lrr.property.registrationNumber.validationError" />"   />
